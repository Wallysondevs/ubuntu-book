import{j as e,T as a}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as r}from"./AlertBox-NzOB7YP7.js";function m(){return e.jsxs(s,{title:"Permissões de Arquivos",subtitle:"chmod, chown, umask — entendendo e gerenciando o sistema de permissões do Linux de forma completa e segura.",difficulty:"intermediario",timeToRead:"20 min",children:[e.jsxs(r,{type:"info",title:"Pré-requisitos",children:["Saber abrir o terminal e navegar entre pastas (",e.jsx("code",{children:"cd"}),", ",e.jsx("code",{children:"ls"}),"). Conhecer a diferença entre arquivo e diretório. Útil ter feito o capítulo de",e.jsx("a",{href:"#/usuarios",children:" Usuários e Grupos"}),"."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Permissão"})," — define quem pode ler (r), escrever (w) e executar (x) cada arquivo. No Linux, tudo (inclusive dispositivos e diretórios) tem permissões."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Octal"})," — notação numérica das permissões (0-7). 7=rwx, 6=rw-, 5=r-x, 4=r--.",e.jsx("code",{children:"chmod 755"})," = dono rwx, grupo r-x, outros r-x."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"umask"})," — máscara que define as permissões padrão de arquivos novos. Ubuntu padrão é 022 (arquivos nascem 644, diretórios 755)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Setuid / Setgid / Sticky bit"})," — permissões especiais. Setuid faz o binário rodar como o dono (ex.: ",e.jsx("code",{children:"passwd"}),"). Sticky em diretório (",e.jsx("code",{children:"/tmp"}),") impede que um usuário apague arquivo de outro."]}),e.jsx("p",{children:"O sistema de permissões do Linux é um dos seus recursos mais poderosos e importantes para segurança. Ele controla quem pode ler, escrever e executar cada arquivo ou diretório. Entender permissões é essencial para administrar qualquer sistema Linux."}),e.jsx("h2",{children:"Lendo Permissões"}),e.jsx(o,{title:"Interpretando a saída do ls -l",code:`ls -l /home/joao/
...
# ---  = sem nenhuma permissão               = 0+0+0 = 0`}),e.jsx("p",{children:"Na prática, lendo permissões e esbarrando numa negada:"}),e.jsx(a,{user:"joao",title:"joao@ubuntu: ~/projeto",lines:[{type:"cmd",text:"ls -l"},{type:"out",text:"total 8"},{type:"out",text:"-rw-r--r-- 1 joao  joao   220 jul  4 10:00 notas.txt"},{type:"out",text:"-rwxr-xr-x 1 joao  joao  1820 jul  4 10:01 deploy.sh"},{type:"out",text:"-rw------- 1 root  root    64 jul  4 09:12 segredo.env"},{type:"comment",text:"# tentando ler um arquivo que pertence ao root:"},{type:"cmd",text:"cat segredo.env"},{type:"err",text:"cat: segredo.env: Permissao negada"},{type:"warn",text:"-> dono e root e mais ninguem pode ler (-rw-------). Use: sudo cat segredo.env"}]}),e.jsx("h2",{children:"chmod — Mudar Permissões"}),e.jsx("h3",{children:"Modo Numérico (Octal)"}),e.jsx(o,{title:"chmod com números octais",code:`# Formato: chmod [user][group][others] arquivo
...
# Sem -R, apenas o diretório raiz receberia a permissão.`}),e.jsx("h3",{children:"Modo Simbólico (mais legível para iniciantes)"}),e.jsx(o,{title:"chmod com símbolos — mais fácil de entender",code:`# Formato: chmod [quem][operação][permissão] arquivo
...
# -type d = apenas diretórios (d = directory)`}),e.jsxs(r,{type:"warning",title:"Permissões em diretórios são diferentes!",children:["Para ",e.jsx("strong",{children:"diretórios"}),", as letras têm significados diferentes dos arquivos:",e.jsxs("ul",{className:"mt-1 mb-0",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"r"})," = listar o conteúdo do diretório (",e.jsx("code",{children:"ls"}),")"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"w"})," = criar, renomear ou deletar arquivos DENTRO do diretório"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"x"})," = entrar no diretório (",e.jsx("code",{children:"cd"}),") e acessar seus conteúdos"]})]}),"Um diretório com ",e.jsx("code",{children:"r--"})," permite ver a lista mas não entrar. Com ",e.jsx("code",{children:"--x"}),"você pode entrar mas não ver a lista. Na prática sempre use ",e.jsx("code",{children:"r-x"})," (5) ou ",e.jsx("code",{children:"rwx"})," (7) para diretórios."]}),e.jsx("h2",{children:"chown — Mudar Dono e Grupo"}),e.jsx(o,{title:"Mudando a propriedade de arquivos",code:`# Mudar o DONO de um arquivo
...
#    O usuário precisa fazer logout e login novamente.`}),e.jsx("h2",{children:"Permissões Especiais"}),e.jsx(o,{title:"SUID, SGID e Sticky Bit explicados",code:`# === SUID (Set User ID) ===
...
# %a = exibir permissões em octal (ex: 4755 = SUID + 755)`}),e.jsx("h2",{children:"umask — Permissões Padrão para Novos Arquivos"}),e.jsx(o,{title:"Como o umask define permissões padrão",code:`# Ver o umask atual do usuário
umask
...
# ~/.bashrc é executado a cada abertura de terminal`}),e.jsx("h2",{children:"ACL — Controle de Acesso Avançado"}),e.jsx("p",{children:"O sistema padrão do Linux só permite definir permissões para três entidades: dono, grupo e outros. A ACL (Access Control List) permite dar permissões específicas para qualquer usuário ou grupo, indo além dessa limitação."}),e.jsx(o,{title:"ACL: permissões granulares por usuário",code:`# Instalar ferramentas de ACL
...
#            ^ + = este arquivo tem ACLs adicionais`})]})}export{m as default};
