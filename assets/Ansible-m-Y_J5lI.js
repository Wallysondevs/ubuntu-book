import{j as e}from"./index-_kFPLDpE.js";import{P as i}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as s}from"./AlertBox-NzOB7YP7.js";function l(){return e.jsxs(i,{title:"Ansible — Automação de Infraestrutura",subtitle:"Guia completo do Ansible no Ubuntu: instalação, inventários, playbooks, roles, modules, vaults e automação de servidores em escala.",difficulty:"avancado",timeToRead:"40 min",children:[e.jsxs(s,{type:"info",title:"Pré-requisitos",children:["Ubuntu/qualquer Linux com Python 3 nos nós gerenciados. Acesso SSH com chave para os hosts. Útil ter visto ",e.jsx("a",{href:"#/ssh",children:"SSH"}),"."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Ansible"})," — ferramenta de automação agentless: usa SSH em vez de instalar agente em cada máquina."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Inventory"})," — arquivo (INI ou YAML) que lista os hosts gerenciados, agrupados por função."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Playbook"})," — arquivo YAML que descreve as tarefas a executar nos hosts."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Role"})," — playbook estruturado e reutilizável (tasks, handlers, vars, templates) — padrão da comunidade."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Idempotência"})," — rodar o playbook várias vezes deixa o sistema no mesmo estado. Pilar do Ansible."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Ansible"})," é uma ferramenta de automação de infraestrutura que permite configurar, gerenciar e fazer deploy em centenas de servidores simultaneamente usando apenas SSH. Diferente de ferramentas como Puppet ou Chef, o Ansible é ",e.jsx("em",{children:"agentless"})," — não precisa instalar nada nos servidores gerenciados, apenas SSH e Python."]}),e.jsx("h2",{children:"Por Que Ansible?"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Agentless"})," — Não precisa instalar software nos servidores gerenciados. Usa SSH."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Idempotente"})," — Executar a mesma tarefa várias vezes produz o mesmo resultado. Se o servidor já está configurado, nada muda."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"YAML"})," — Configuração em YAML legível por humanos, não em linguagem de programação."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Push-based"})," — Você executa os comandos do seu computador e eles são aplicados nos servidores remotos."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Extensível"})," — Milhares de módulos para cloud (AWS, Azure, GCP), containers (Docker, K8s), redes e mais."]})]}),e.jsx("h2",{children:"1. Instalação do Ansible"}),e.jsx(a,{title:"Instalar o Ansible no Ubuntu",code:`# Método 1: Via apt (versão estável do Ubuntu)
  sudo apt update
