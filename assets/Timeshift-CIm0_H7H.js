import{j as s}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as e}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function d(){return s.jsxs(a,{title:"Timeshift — Snapshots do Sistema",subtitle:"Guia completo do Timeshift no Ubuntu: criar, gerenciar e restaurar snapshots do sistema, agendamento automático e recuperação de desastres.",difficulty:"iniciante",timeToRead:"25 min",children:[s.jsxs(o,{type:"info",title:"Pré-requisitos",children:["Ubuntu Desktop, ",s.jsx("code",{children:"sudo"}),", espaço em disco para snapshots. Não é backup de dados pessoais — é snapshot do sistema!"]}),s.jsx("h2",{children:"Glossário rápido"}),s.jsxs("p",{children:[s.jsx("strong",{children:"Timeshift"})," — equivalente Linux do System Restore do Windows. Snapshot do sistema (não do ",s.jsx("code",{children:"/home"})," por padrão)."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"rsync mode"})," — funciona em qualquer filesystem. Snapshots incrementais com hard links."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"btrfs mode"})," — usa snapshots nativos do Btrfs — instantâneo e barato."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"Boot snapshot"})," — agendado automaticamente no boot — útil antes de upgrades."]}),s.jsxs("p",{children:["O ",s.jsx("strong",{children:"Timeshift"}),' é a ferramenta de restauração do sistema mais popular no Ubuntu/Linux. Funciona como o "Restauração do Sistema" do Windows ou o Time Machine do macOS — cria snapshots do sistema que podem ser restaurados se algo der errado após uma atualização, instalação de driver ou configuração.']}),s.jsx("h2",{children:"rsync vs Btrfs — Modos de Operação"}),s.jsxs("ul",{children:[s.jsxs("li",{children:[s.jsx("strong",{children:"rsync"})," — Funciona em qualquer sistema de arquivos (ext4, xfs, etc.). Cria hard links para economizar espaço. Mais lento, mas mais compatível."]}),s.jsxs("li",{children:[s.jsx("strong",{children:"Btrfs"})," — Usa snapshots nativos do Btrfs. Quase instantâneo, não usa espaço extra até que arquivos sejam modificados (Copy-on-Write). Requer partição Btrfs."]})]}),s.jsx("h2",{children:"1. Instalar e Configurar"}),s.jsx(e,{title:"Instalar o Timeshift",code:`# Instalar o Timeshift
  sudo apt update
  ...
  sudo timeshift-gtk 2>&1`}),s.jsxs(o,{type:"info",title:"Timeshift vs Snapper",children:["Se você usa Btrfs, o ",s.jsx("strong",{children:"Snapper"})," é uma alternativa ao Timeshift com integração mais profunda ao sistema de snapshots do Btrfs. O openSUSE usa Snapper por padrão. No Ubuntu com ext4, o Timeshift com rsync é a melhor opção."]})]})}export{d as default};
