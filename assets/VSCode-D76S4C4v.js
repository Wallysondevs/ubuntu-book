import{j as e}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as t}from"./AlertBox-NzOB7YP7.js";function l(){return e.jsxs(a,{title:"Visual Studio Code no Ubuntu",subtitle:"Instalação, configuração, extensões essenciais, atalhos de teclado, terminal integrado, debug, Git integrado e dicas de produtividade.",difficulty:"iniciante",timeToRead:"30 min",children:[e.jsxs(t,{type:"info",title:"Pré-requisitos",children:["Ubuntu Desktop, ",e.jsx("code",{children:"sudo"}),". Recomendado instalar via repo oficial Microsoft (assim o ",e.jsx("code",{children:"apt"})," atualiza junto)."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"VS Code"})," — editor de código gratuito da Microsoft, baseado em Electron. Open source (MIT)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"VSCodium"})," — rebuild de código aberto sem telemetria Microsoft."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Extensions"})," — plugins para linguagens, temas e ferramentas. Marketplace integrado."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Remote SSH"})," — editar arquivos em servidor remoto como se fossem locais."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"settings.json"})," — config em JSON — sincroniza com sua conta."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Visual Studio Code"})," (VS Code) é o editor de código mais popular do mundo — gratuito, open source (pela Microsoft) e extremamente extensível. Suporta praticamente todas as linguagens de programação, tem terminal integrado, debug visual, controle Git nativo e milhares de extensões."]}),e.jsx("h2",{children:"1. Instalação"}),e.jsx(o,{title:"Instalar o VS Code no Ubuntu",code:`# Método 1: Via repositório oficial da Microsoft (recomendado)
  ...
  # Verificar a versão
  code --version`}),e.jsx("h2",{children:"2. Extensões Essenciais"}),e.jsx(o,{title:"Instalar extensões populares",code:`# Instalar extensões via terminal
  ...
  code --uninstall-extension nome-da-extensao`}),e.jsx("h2",{children:"3. Atalhos de Teclado Essenciais"}),e.jsx(o,{title:"Atalhos mais úteis do VS Code",code:`# === GERAL ===
  ...
  # Ctrl+Shift+H    → Substituir em todos os arquivos`}),e.jsx("h2",{children:"4. Configurações Recomendadas"}),e.jsx(o,{title:"settings.json — configurações do VS Code",code:`# Abrir settings.json: Ctrl+Shift+P → "Open User Settings (JSON)"
  ...
  # Ou baixar JetBrains Mono: jetbrains.com/mono`}),e.jsx("h2",{children:"5. Terminal Integrado e Remote SSH"}),e.jsx(o,{title:"Usar o terminal e acesso remoto",code:`# Abrir terminal: Ctrl+\` ou Ctrl+Shift+\`
  ...
  # Se usa Windows + WSL:
  code --install-extension ms-vscode-remote.remote-wsl`}),e.jsx("h2",{children:"6. Debug Visual"}),e.jsx(o,{title:"Configurar debug no VS Code",code:`# O VS Code tem debug integrado para muitas linguagens
  # F5           → Iniciar debug
  ...
  }`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(o,{title:"Problemas comuns com VS Code",code:`# VS Code lento ou travando
  ...
  # VSCodium: mesma interface, sem rastreamento`}),e.jsxs(t,{type:"info",title:"VS Code vs outros editores",children:["Alternativas populares no Linux: ",e.jsx("strong",{children:"Neovim"})," (para quem gosta do Vim),",e.jsx("strong",{children:"Sublime Text"})," (rápido e leve), ",e.jsx("strong",{children:"JetBrains IDEs"}),"(PyCharm, WebStorm — mais pesados mas com mais features built-in). O VS Code é o equilíbrio entre leveza e funcionalidades."]})]})}export{l as default};
