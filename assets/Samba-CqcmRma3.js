import{j as s}from"./index-_kFPLDpE.js";import{P as e}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function m(){return s.jsxs(e,{title:"Samba — Compartilhamento de Arquivos",subtitle:"Guia completo do Samba no Ubuntu: compartilhar pastas com Windows, macOS e Linux na rede local, permissões, autenticação e segurança.",difficulty:"intermediario",timeToRead:"30 min",children:[s.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu Server/Desktop, ",s.jsx("code",{children:"sudo"}),". Útil ter rede local com Windows ou outros Linux para testar."]}),s.jsx("h2",{children:"Glossário rápido"}),s.jsxs("p",{children:[s.jsx("strong",{children:"Samba"})," — implementação livre dos protocolos SMB/CIFS — compartilhar arquivos com Windows."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"SMB / CIFS"})," — protocolo de compartilhamento de arquivos do Windows."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"smb.conf"})," — arquivo de configuração principal — ",s.jsx("code",{children:"/etc/samba/smb.conf"}),"."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"smbpasswd"})," — define a senha Samba do usuário (separada da senha do sistema)."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"Workgroup"})," — grupo de máquinas Windows na mesma rede. Padrão: ",s.jsx("code",{children:"WORKGROUP"}),"."]}),s.jsxs("p",{children:["O ",s.jsx("strong",{children:"Samba"})," implementa o protocolo SMB/CIFS, permitindo que máquinas Linux compartilhem arquivos e impressoras com Windows, macOS e outros sistemas na rede local. É a forma mais fácil de criar um servidor de arquivos acessível por qualquer computador ou dispositivo na rede."]}),s.jsx("h2",{children:"1. Instalação e Configuração Básica"}),s.jsx(o,{title:"Instalar e configurar o Samba",code:`# Instalar o Samba
  sudo apt update
  ...
  # Ver logs de erro
  sudo tail -f /var/log/samba/log.smbd`}),s.jsxs(a,{type:"info",title:"Samba vs NFS",children:["Use ",s.jsx("strong",{children:"Samba"})," quando precisar compartilhar com Windows/macOS ou em redes mistas. Use ",s.jsx("strong",{children:"NFS"})," para compartilhamento entre máquinas Linux (mais rápido e nativo). Para ambos os cenários, o Samba é a escolha mais versátil."]})]})}export{m as default};
