import{j as e}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as r}from"./AlertBox-NzOB7YP7.js";function d(){return e.jsxs(s,{title:"Processo de Boot do Ubuntu",subtitle:"Guia completo do boot no Ubuntu: UEFI vs BIOS, GRUB, systemd, targets, serviços de inicialização e recuperação.",difficulty:"avancado",timeToRead:"25 min",children:[e.jsxs(r,{type:"info",title:"Pré-requisitos",children:["Ubuntu instalado, ",e.jsx("code",{children:"sudo"}),". Útil ter visto ",e.jsx("a",{href:"#/systemd",children:"systemd"}),". Cuidado: erros em GRUB podem deixar o sistema sem boot — sempre teste em VM antes."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"UEFI / BIOS"})," — firmware que inicia o hardware antes do sistema. UEFI é o moderno (gpt, secure boot); BIOS é o legado."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"GRUB"})," — bootloader padrão do Ubuntu. Escolhe qual kernel/sistema iniciar."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"initramfs"})," — sistema de arquivos mínimo carregado em RAM antes do root real. Permite carregar drivers (LUKS, LVM, NVMe)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Target"})," — alvo do systemd que define o estado do boot. ",e.jsx("code",{children:"graphical.target"})," = com GUI; ",e.jsx("code",{children:"multi-user.target"})," = só CLI; ",e.jsx("code",{children:"rescue.target"})," = monouser."]}),e.jsx("p",{children:"Entender o processo de boot é essencial para diagnosticar problemas de inicialização, configurar dual boot, otimizar o tempo de boot e recuperar sistemas que não iniciam. O Ubuntu usa GRUB como bootloader e systemd para gerenciar serviços."}),e.jsx("h2",{children:"1. Sequência de Boot"}),e.jsx(o,{title:"Etapas do boot do Ubuntu",code:`# Sequência completa de boot:
