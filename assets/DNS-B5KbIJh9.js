import{j as e}from"./index-_kFPLDpE.js";import{P as r}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as s}from"./AlertBox-NzOB7YP7.js";function l(){return e.jsxs(r,{title:"DNS — Resolução de Nomes no Ubuntu",subtitle:"Guia completo de DNS: como funciona, configurar servidores DNS, systemd-resolved, dig, nslookup, hosts e DNS over HTTPS.",difficulty:"intermediario",timeToRead:"30 min",children:[e.jsxs(s,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",e.jsx("code",{children:"sudo"}),". Útil ter visto ",e.jsx("a",{href:"#/redes",children:"Redes"})," e ",e.jsx("a",{href:"#/netplan",children:"Netplan"}),"."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"DNS"})," — sistema que traduz nomes (",e.jsx("code",{children:"google.com"}),") em IPs (",e.jsx("code",{children:"142.250.x.x"}),")."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"systemd-resolved"})," — resolvedor DNS padrão do Ubuntu moderno. Fica em ",e.jsx("code",{children:"127.0.0.53"}),"."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"/etc/resolv.conf"})," — arquivo legado — no Ubuntu é um symlink gerado pelo systemd-resolved."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"dig / nslookup / host"})," — utilitários para consultar DNS manualmente. ",e.jsx("code",{children:"dig"})," é o mais informativo."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"DNS"})," (Domain Name System) é o sistema que traduz nomes de domínio (como ",e.jsx("code",{children:"google.com"}),") em endereços IP (como ",e.jsx("code",{children:"142.250.218.46"}),"). Sem DNS, você precisaria memorizar IPs para acessar qualquer site. No Ubuntu, o ",e.jsx("strong",{children:"systemd-resolved"})," gerencia a resolução de nomes por padrão."]}),e.jsx("h2",{children:"1. Verificar e Configurar DNS"}),e.jsx(o,{title:"Gerenciar DNS no Ubuntu",code:`# Ver o servidor DNS atual
  resolvectl status
