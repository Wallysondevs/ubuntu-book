import{j as e}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as s}from"./AlertBox-NzOB7YP7.js";function d(){return e.jsxs(a,{title:"Node.js no Ubuntu",subtitle:"Instalação via NVM, gerenciamento de versões, NPM, Yarn, PNPM, criação de projetos, PM2 para produção e deploy de aplicações Node.js.",difficulty:"intermediario",timeToRead:"35 min",children:[e.jsxs(s,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",e.jsx("code",{children:"sudo"}),". Recomendado instalar via NodeSource ou nvm — o pacote do Ubuntu costuma ser antigo."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Node.js"})," — runtime JavaScript fora do navegador, baseado no V8 do Chrome."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"npm"})," — Node Package Manager — gerenciador de pacotes oficial."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"nvm"})," — Node Version Manager — instala várias versões do Node lado a lado."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"NodeSource"})," — repositório APT mantido oficialmente para versões recentes do Node no Ubuntu."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"package.json"})," — manifesto do projeto: dependências, scripts, metadados."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Node.js"})," é um runtime JavaScript construído sobre o motor V8 do Chrome, permitindo executar JavaScript fora do navegador. É a base de frameworks como Express, Next.js, Nest.js, e ferramentas como Webpack, Vite e ESLint."]}),e.jsx("h2",{children:"Métodos de Instalação"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"NVM (recomendado)"})," — Gerenciador de versões. Permite ter múltiplas versões instaladas e alternar entre elas facilmente."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"NodeSource"})," — Repositório oficial com versões atualizadas. Instala uma única versão global."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"apt"})," — Versão dos repositórios do Ubuntu. Geralmente desatualizada."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"fnm"})," — Alternativa ao NVM, escrita em Rust (mais rápida)."]})]}),e.jsx("h2",{children:"1. Instalar via NVM (Recomendado)"}),e.jsx(o,{title:"Instalar o NVM e o Node.js",code:`# Instalar o NVM (Node Version Manager)
