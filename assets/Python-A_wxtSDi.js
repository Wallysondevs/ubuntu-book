import{j as e}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as t}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function p(){return e.jsxs(s,{title:"Python no Ubuntu",subtitle:"Gerenciar versões do Python, pip, venv, pyenv, instalar pacotes, criar projetos e boas práticas de desenvolvimento Python no Ubuntu.",difficulty:"iniciante",timeToRead:"30 min",children:[e.jsx(a,{type:"info",title:"Pré-requisitos",children:"Ubuntu já vem com Python 3 instalado. Útil saber editar arquivos no terminal."}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Python"})," — linguagem de programação interpretada, generalista, com sintaxe limpa."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"python3 / python"})," — no Ubuntu moderno, ",e.jsx("code",{children:"python"})," não existe por padrão — use ",e.jsx("code",{children:"python3"}),". Pacote ",e.jsx("code",{children:"python-is-python3"})," cria o alias."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"pip"})," — gerenciador de pacotes do Python. Pacote ",e.jsx("code",{children:"python3-pip"}),"."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"venv"})," — ambiente virtual isolado. Sempre use venv para projetos."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"PEP 668"})," — desde Ubuntu 23.04 não dá pra ",e.jsx("code",{children:"pip install"})," global — força uso de venv."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Python"})," já vem pré-instalado no Ubuntu (é usado internamente pelo sistema). No entanto, é importante saber gerenciar versões, ambientes virtuais e pacotes para desenvolvimento sem conflitar com o Python do sistema."]}),e.jsx("h2",{children:"1. Python no Ubuntu"}),e.jsx(t,{title:"Verificar e instalar Python",code:`# Verificar versão instalada
  python3 --version
  ...
  pip install uv
  uv pip install -r requirements.txt`})]})}export{p as default};
