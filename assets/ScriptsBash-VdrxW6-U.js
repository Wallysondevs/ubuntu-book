import{j as e}from"./index-SIHT01g3.js";import{P as a}from"./PageContainer-BmB2S7A9.js";import{C as o}from"./CodeBlock-CqOgj4bq.js";import{I as r}from"./InfoBox-CqgguQ_S.js";import"./house-D4pt-aba.js";import"./proxy-DliY8Vv8.js";function u(){return e.jsxs(a,{title:"Scripts Bash — Automação no Terminal",subtitle:"Guia completo de shell scripting: variáveis, condições, loops, funções, arrays, tratamento de erros, debug e boas práticas.",difficulty:"intermediario",timeToRead:"35 min",children:[e.jsxs("p",{children:[e.jsx("strong",{children:"Scripts Bash"})," automatizam tarefas repetitivas no terminal. Um script é simplesmente um arquivo de texto com uma sequência de comandos que o Bash executa em ordem. Desde backups automáticos até deploys complexos, scripts são a base da automação em servidores Linux."]}),e.jsx("h2",{children:"1. Primeiro Script"}),e.jsx(o,{title:"Criar e executar scripts Bash",code:`# Criar um script
 ...
 no final das linhas (arquivo criado no Windows)
  # Solução:
  sed -i 's/\r$//' script.sh
  # Ou: dos2unix script.sh`}),e.jsxs(r,{type:"info",title:"Quando usar Bash vs Python",children:["Use ",e.jsx("strong",{children:"Bash"})," para: automação de comandos do sistema, pipes, tarefas rápidas do terminal, scripts de deploy. Use ",e.jsx("strong",{children:"Python"})," para: lógica complexa, manipulação de dados, APIs, scripts maiores que 100 linhas. A regra: se o script tem mais lógica que comandos, use Python."]})]})}export{u as default};
