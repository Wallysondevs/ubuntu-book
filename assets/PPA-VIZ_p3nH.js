import{j as e}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function d(){return e.jsxs(s,{title:"PPA — Repositórios Pessoais",subtitle:"Guia completo de PPAs no Ubuntu: adicionar, remover, gerenciar repositórios de terceiros, segurança e alternativas.",difficulty:"intermediario",timeToRead:"20 min",children:[e.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu com terminal e ",e.jsx("code",{children:"sudo"}),". Útil ter visto ",e.jsx("a",{href:"#/apt",children:"APT"})," e ",e.jsx("a",{href:"#/dpkg",children:"dpkg"}),". PPAs vêm de pessoas (não da Canonical) — sempre verifique o autor antes de adicionar."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"PPA (Personal Package Archive)"})," — repositório pessoal hospedado no Launchpad. Permite distribuir ",e.jsx("code",{children:".deb"})," compilados para versões específicas do Ubuntu."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"add-apt-repository"})," — comando que adiciona um PPA, baixa a chave GPG e atualiza a lista de fontes em ",e.jsx("code",{children:"/etc/apt/sources.list.d/"}),"."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"ppa-purge"})," — remove um PPA ",e.jsx("em",{children:"e"})," reverte os pacotes para a versão oficial."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Launchpad"})," — plataforma da Canonical que hospeda PPAs, código e bug tracking."]}),e.jsxs("p",{children:["Os ",e.jsx("strong",{children:"PPAs"})," (Personal Package Archives) são repositórios mantidos pela comunidade no Launchpad, permitindo instalar software que não está nos repositórios oficiais do Ubuntu ou versões mais recentes de pacotes existentes. São a forma mais fácil de obter software atualizado no Ubuntu."]}),e.jsx("h2",{children:"1. Adicionar e Usar PPAs"}),e.jsx(o,{title:"Gerenciar PPAs no Ubuntu",code:`# Adicionar um PPA
  ...
  sudo mv /tmp/ppa-problematico.list /etc/apt/sources.list.d/`}),e.jsxs(a,{type:"warning",title:"PPAs e atualizações do Ubuntu",children:["Ao atualizar o Ubuntu para uma nova versão (ex: 22.04 → 24.04), todos os PPAs são ",e.jsx("strong",{children:"automaticamente desabilitados"}),". Após a atualização, você precisa reativar manualmente cada PPA e verificar se ele suporta a nova versão."]})]})}export{d as default};
