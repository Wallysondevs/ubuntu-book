import{j as e}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as r}from"./AlertBox-NzOB7YP7.js";function d(){return e.jsxs(a,{title:"Redirecionamento e Pipes",subtitle:"Guia completo de redirecionamento no Bash: stdin, stdout, stderr, pipes, tee, xargs, substituição de processos e combinações avançadas.",difficulty:"intermediario",timeToRead:"25 min",children:[e.jsxs("p",{children:["O ",e.jsx("strong",{children:"redirecionamento"})," permite controlar para onde vai a saída de um comando e de onde vem sua entrada. Junto com ",e.jsx("strong",{children:"pipes"})," (",e.jsx("code",{children:"|"}),"), é uma das funcionalidades mais poderosas do terminal Linux, permitindo encadear comandos para criar fluxos de processamento complexos."]}),e.jsx("h2",{children:"1. Descritores de Arquivo"}),e.jsx(o,{title:"Entender stdin, stdout e stderr",code:`# Todo processo no Linux tem 3 fluxos padrão:
  ...
  # 2 = stderr`}),e.jsx("h2",{children:"2. Redirecionar Saída (stdout)"}),e.jsx(o,{title:"Enviar saída para arquivos",code:`# > (redirecionar, SOBRESCREVE o arquivo)
  ...
  find / -name "*.conf" > /dev/null 2>&1   # Ignorar tudo`}),e.jsx("h2",{children:"3. Redirecionar Erros (stderr)"}),e.jsx(o,{title:"Controlar saída de erros",code:`# Redirecionar apenas erros
  ...
  # Descartar tudo
  comando &> /dev/null`}),e.jsx("h2",{children:"4. Pipes (|)"}),e.jsx(o,{title:"Encadear comandos com pipes",code:`# O pipe (|) envia o stdout de um comando para o stdin do próximo
  ...
  find . -type f | sed 's/.*.//' | sort | uniq -c | sort -rn`}),e.jsx("h2",{children:"5. Redirecionar Entrada (stdin)"}),e.jsx(o,{title:"Fornecer entrada a partir de arquivos",code:`# < (redirecionar entrada)
  ...
  EOF`}),e.jsx("h2",{children:"6. tee, xargs e Substituição de Processos"}),e.jsx(o,{title:"Ferramentas avançadas de redirecionamento",code:`# tee — enviar para arquivo E tela ao mesmo tempo
  ...
  # Combinar tudo
  ps aux | tee processos.txt | grep nginx | wc -l`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(o,{title:"Problemas comuns com redirecionamento",code:`# "Permission denied" ao redirecionar com sudo
  ...
  # Use o caminho completo ou funções`}),e.jsxs(r,{type:"info",title:"Filosofia Unix",children:["A filosofia Unix é: cada programa faz uma coisa bem, e pipes os conectam.",e.jsx("code",{children:"grep"})," filtra, ",e.jsx("code",{children:"sort"})," ordena, ",e.jsx("code",{children:"wc"})," conta,",e.jsx("code",{children:"awk"})," processa — juntos, fazem praticamente qualquer coisa."]})]})}export{d as default};
