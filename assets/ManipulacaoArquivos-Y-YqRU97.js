import{j as o}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as e}from"./CodeBlock-ByIkwE54.js";import{A as r}from"./AlertBox-NzOB7YP7.js";function n(){return o.jsxs(a,{title:"Manipulação de Arquivos",subtitle:"cp, mv, rm, mkdir, touch, ln — criando, copiando, movendo e removendo arquivos e diretórios com segurança e eficiência.",difficulty:"iniciante",timeToRead:"20 min",children:[o.jsxs(r,{type:"info",title:"Pré-requisitos",children:["Ubuntu com terminal aberto. Útil ter visto ",o.jsx("a",{href:"#/navegacao",children:"Navegação"})," e ",o.jsx("a",{href:"#/permissoes",children:"Permissões"}),"."]}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("p",{children:[o.jsx("strong",{children:"cp / mv / rm"})," — copiar, mover, remover. ",o.jsx("code",{children:"-r"})," para diretórios; ",o.jsx("code",{children:"-i"})," pergunta antes de sobrescrever."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"ln"})," — cria links. ",o.jsx("code",{children:"-s"})," = symlink (atalho); sem ",o.jsx("code",{children:"-s"})," = hard link (mesmo inode)."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"touch"})," — cria arquivo vazio ou atualiza mtime/atime de um existente."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"stat"})," — mostra todos os metadados (inode, links, datas, permissões)."]}),o.jsx("p",{children:"Manipular arquivos é uma das atividades mais básicas e importantes no terminal Linux. Esses comandos parecem simples mas têm opções poderosas que economizam muito tempo no dia a dia. Aprenda-os bem — você os usará constantemente."}),o.jsx("h2",{children:"mkdir — Criar Diretórios"}),o.jsx(e,{title:"Criando diretórios",code:`# Criar um diretório simples
mkdir MeuDiretorio
...
# Equivale a: cp arquivo.conf arquivo.conf.bak (cria backup renomeando)`})]})}export{n as default};
