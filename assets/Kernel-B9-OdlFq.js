import{j as e}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as r}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function t(){return e.jsxs(a,{title:"Kernel Linux no Ubuntu",subtitle:"Guia completo do kernel: verificar versão, atualizar, instalar kernels alternativos, módulos, parâmetros e compilar kernel customizado.",difficulty:"avancado",timeToRead:"25 min",children:[e.jsxs(o,{type:"info",title:"Pré-requisitos",children:["Ubuntu instalado, ",e.jsx("code",{children:"sudo"}),", espaço em ",e.jsx("code",{children:"/boot"})," (mínimo 500 MB livres). Trocar de kernel pode quebrar drivers proprietários (NVIDIA, Wi-Fi). Tenha sempre o kernel anterior listado no GRUB para fallback."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Kernel"})," — núcleo do sistema operacional. Conversa com o hardware e gerencia processos, memória, I/O. No Ubuntu chama ",e.jsx("code",{children:"linux-image-*"}),"."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"HWE (Hardware Enablement)"})," — kernels mais novos portados para LTS, dão suporte a hardware recente. ",e.jsx("code",{children:"linux-generic-hwe-24.04"}),"."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Mainline"}),' — kernel "puro" do kernel.org, sem patches do Ubuntu. Para os curiosos.']}),e.jsxs("p",{children:[e.jsx("strong",{children:"Módulo do kernel"})," — driver carregável dinamicamente (",e.jsx("code",{children:"modprobe"}),", ",e.jsx("code",{children:"lsmod"}),")."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"kernel"})," é o coração do sistema operacional. Ele gerencia todo o hardware (CPU, memória, discos, rede), processos, sistemas de arquivos e segurança. O Ubuntu usa o kernel Linux, mantido por Linus Torvalds e milhares de contribuidores."]}),e.jsx("h2",{children:"1. Informações do Kernel"}),e.jsx(r,{title:"Verificar versão e informações",code:`# Ver versão do kernel
  uname -r
  ...
  sudo apt remove linux-image-6.8.0-39-generic`}),e.jsx("h2",{children:"3. Módulos do Kernel"}),e.jsx(r,{title:"Gerenciar módulos (drivers)",code:`# Listar módulos carregados
  lsmod
