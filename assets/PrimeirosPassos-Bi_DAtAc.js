import{j as e,T as s}from"./index-_kFPLDpE.js";import{P as i}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function c(){return e.jsxs(i,{title:"Primeiros Passos Pós-Instalação",subtitle:"Acabou de instalar o Ubuntu? Configure drivers, repositórios, idioma e aplicativos essenciais para ter um sistema completo.",difficulty:"iniciante",timeToRead:"20 min",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:"Ubuntu instalado (Desktop ou Server). Acesso a teclado e tela, ou SSH se for Server."}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Sessão"})," — sua conta de usuário logada — gráfica ou terminal."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Terminal"})," — aplicativo onde você digita comandos. Atalho: ",e.jsx("kbd",{children:"Ctrl"}),"+",e.jsx("kbd",{children:"Alt"}),"+",e.jsx("kbd",{children:"T"}),"."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Sudo"})," — executar comando como root. Pede sua senha (não a do root)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Atualização"})," — ",e.jsx("code",{children:"sudo apt update"})," (lista) seguido de ",e.jsx("code",{children:"sudo apt upgrade"})," (aplica)."]}),e.jsx("p",{children:"Parabéns pela instalação! O Ubuntu já vem bastante completo, mas há algumas configurações importantes a fazer logo após a primeira inicialização. Siga estes passos em ordem para garantir um sistema atualizado, com todos os drivers corretos e as ferramentas que você vai usar no dia a dia."}),e.jsx("h2",{children:"1. Atualizar o Sistema Completamente"}),e.jsx("p",{children:"A primeira coisa sempre é atualizar — a ISO que você usou para instalar pode ter algumas semanas de atraso. Garanta que tudo está na versão mais recente:"}),e.jsx(a,{title:"Atualização completa do sistema",code:`# Atualizar a lista de pacotes disponíveis
sudo apt update
...
# Usa apt clean (sem "auto") para apagar o cache inteiro.`}),e.jsx("p",{children:"Executando de verdade, a saída é mais ou menos esta:"}),e.jsx(s,{title:"wallyson@ubuntu: ~",lines:[{type:"cmd",text:"sudo apt update"},{type:"out",text:"Atingido:1 http://br.archive.ubuntu.com/ubuntu resolute InRelease"},{type:"out",text:"Obter:2 http://br.archive.ubuntu.com/ubuntu resolute-updates InRelease [126 kB]"},{type:"out",text:"Lendo listas de pacotes... Pronto"},{type:"ok",text:"42 pacotes podem ser atualizados. Execute 'apt list --upgradable'."},{type:"comment",text:"# se a rede estiver fora, o erro e este:"},{type:"cmd",text:"sudo apt update"},{type:"err",text:"Err:1 http://br.archive.ubuntu.com/ubuntu resolute InRelease"},{type:"err",text:"  Temporary failure resolving 'br.archive.ubuntu.com'"},{type:"warn",text:"-> sem internet/DNS. Veja a licao de Redes para diagnosticar."}]}),e.jsxs(o,{type:"info",title:"apt update vs apt upgrade",children:[e.jsx("code",{children:"apt update"})," apenas atualiza a ",e.jsx("em",{children:"lista"})," de pacotes disponíveis (como verificar se há atualizações). Não instala nada. ",e.jsx("code",{children:"apt upgrade"})," de fato instala as atualizações. Sempre faça os dois juntos."]}),e.jsx("h2",{children:"2. Instalar Drivers de Hardware"}),e.jsx("h3",{children:"Driver NVIDIA (GPU dedicada)"}),e.jsx(a,{title:"Instalar drivers NVIDIA recomendados",code:`# Verificar se tem GPU NVIDIA conectada
lspci | grep -i nvidia
...
nvidia-smi
# smi = System Management Interface — mostra GPU, temperatura, uso de VRAM`}),e.jsx("h3",{children:"Driver Wi-Fi Proprietário"}),e.jsx(a,{title:"Instalar drivers de Wi-Fi",code:`# Verificar adaptador Wi-Fi
...
sudo modprobe wl              # carrega o novo módulo (driver Broadcom)`}),e.jsx("h2",{children:"3. Configurar Idioma e Fuso Horário"}),e.jsx(a,{title:"Configurar localização completa",code:`# Verificar configuração atual de idioma e fuso horário
...
# Verificar resultado:
timedatectl status`}),e.jsx("h2",{children:"4. Instalar Pacotes Essenciais"}),e.jsx(a,{title:"Ferramentas essenciais para qualquer instalação",code:`# A \\ (barra invertida) no final de cada linha significa "continuar na próxima linha".
...
sudo apt install -y \\
    ...
    # necessário para usar o comando add-apt-repository (adicionar repositórios PPA)`}),e.jsx("h2",{children:"5. Habilitar Repositórios Extras"}),e.jsx(a,{title:"Ativar repositórios universe, multiverse e restricted",code:`# Verificar repositórios ativos:
...
# necessário para reproduzir a maioria dos vídeos e músicas`}),e.jsx(o,{type:"info",title:"O que são esses repositórios?",children:e.jsxs("ul",{className:"mt-1 mb-0",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"main"}),": Pacotes livres suportados oficialmente pela Canonical (já ativo por padrão)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"universe"}),": Pacotes livres mantidos pela comunidade (sem garantia de suporte)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"restricted"}),": Drivers proprietários necessários para hardware específico"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"multiverse"}),": Software com restrições de uso (copyright, patentes)"]})]})}),e.jsx("h2",{children:"6. Configurar o Firewall (UFW)"}),e.jsx(a,{title:"Configuração básica do UFW",code:`# O UFW já vem instalado no Ubuntu. Verificar status:
sudo ufw status
...
# verbose = modo detalhado (mostra mais informações do que o status simples)`}),e.jsx("h2",{children:"7. Atualizações Automáticas de Segurança"}),e.jsx(a,{title:"Unattended Upgrades (atualizações automáticas)",code:`# Verificar se está instalado:
...
# APT::Periodic::Unattended-Upgrade "1";    ← instalar atualizações de segurança`}),e.jsx("h2",{children:"8. Instalar Aplicativos do Dia a Dia"}),e.jsx(a,{title:"Aplicativos comuns para Ubuntu Desktop",code:`# Navegadores
...
sudo apt install timeshift             # Timeshift: backup e restauração do sistema`})]})}export{c as default};
