import{j as e}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as r}from"./AlertBox-NzOB7YP7.js";function d(){return e.jsxs(a,{title:"VPN no Ubuntu",subtitle:"Guia completo de VPN: instalar e configurar WireGuard, OpenVPN, conectar a VPNs corporativas, criar servidor VPN próprio.",difficulty:"intermediario",timeToRead:"30 min",children:[e.jsxs(r,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",e.jsx("code",{children:"sudo"}),". Acesso a um servidor VPN (próprio ou de provedor)."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"VPN"})," — Virtual Private Network — túnel criptografado por uma rede pública."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"OpenVPN"})," — protocolo open-source clássico. Usa SSL/TLS."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"WireGuard"})," — protocolo moderno, rápido, com configuração mínima. Embutido no kernel desde 5.6."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Split tunneling"})," — manda só parte do tráfego pelo VPN; o resto vai direto."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Kill switch"})," — bloqueia tráfego fora do VPN se o túnel cair."]}),e.jsxs("p",{children:["Uma ",e.jsx("strong",{children:"VPN"})," (Virtual Private Network) cria um túnel criptografado entre seu computador e um servidor, protegendo seu tráfego de rede. Usos comuns: acessar rede corporativa remotamente, proteger conexões em Wi-Fi público, acessar conteúdo geo-restrito e manter privacidade online."]}),e.jsx("h2",{children:"1. WireGuard (Recomendado)"}),e.jsx(o,{title:"Instalar e configurar WireGuard",code:`# WireGuard é o protocolo VPN mais moderno:
  ...
  # dhcp-option DNS 1.1.1.1`}),e.jsxs(r,{type:"info",title:"WireGuard vs OpenVPN",children:[e.jsx("strong",{children:"WireGuard"})," é mais rápido, mais simples e mais seguro — use para novos setups. ",e.jsx("strong",{children:"OpenVPN"})," é mais maduro e tem mais opções de configuração — use quando a empresa exigir ou quando precisar de recursos avançados como autenticação por certificado com LDAP."]})]})}export{d as default};
