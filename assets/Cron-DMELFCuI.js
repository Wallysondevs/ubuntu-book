import{j as e}from"./index-_kFPLDpE.js";import{P as r}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function c(){return e.jsxs(r,{title:"Cron — Agendamento de Tarefas",subtitle:"Guia completo do cron e systemd timers no Ubuntu: agendar tarefas automáticas, sintaxe do crontab, exemplos práticos e monitoramento.",difficulty:"intermediario",timeToRead:"25 min",children:[e.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu com terminal e ",e.jsx("code",{children:"sudo"}),". Saber editar arquivos de texto com nano/vim. Útil ter visto ",e.jsx("a",{href:"#/systemd",children:"systemd"})," para entender timers."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"cron"})," — daemon que executa comandos em horários pré-definidos. Roda em segundo plano desde os anos 70."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"crontab"})," — arquivo de tabela de tarefas. Cada usuário tem o seu, em",e.jsx("code",{children:"/var/spool/cron/crontabs/<usuario>"}),". Edite com ",e.jsx("code",{children:"crontab -e"}),"."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"systemd timer"})," — alternativa moderna ao cron. Mais flexível (eventos, dependências, log no journal)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Sintaxe cron"})," — 5 campos: minuto (0-59), hora (0-23), dia do mês (1-31), mês (1-12), dia da semana (0-7, 0 e 7 = domingo)."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"cron"})," é o agendador de tarefas padrão do Linux. Permite executar comandos e scripts automaticamente em horários e intervalos definidos — backups diários, limpeza de logs, sincronização de dados, relatórios semanais e qualquer tarefa que precise rodar periodicamente."]}),e.jsx("h2",{children:"1. Sintaxe do Crontab"}),e.jsx(o,{title:"Entender a sintaxe do crontab",code:`# Formato: minuto hora dia-do-mês mês dia-da-semana comando
  #          ┌───── minuto (0-59)
  #          │ ┌───── hora (0-23)
  #          │ │ ┌───── dia do mês (1-31)
  #          │ │ │ ┌───── mês (1-12)
  ...
  * * * * * flock -n /tmp/meu-script.lock /usr/local/bin/meu-script.sh
  ...
  # Ou definir MAILTO="" no crontab`})]})}export{c as default};
