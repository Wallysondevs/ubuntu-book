import{j as o}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as r}from"./CodeBlock-ByIkwE54.js";import{A as e}from"./AlertBox-NzOB7YP7.js";function i(){return o.jsxs(s,{title:"journalctl — Logs do Sistema",subtitle:"Guia completo do journalctl no Ubuntu: visualizar, filtrar, pesquisar e gerenciar logs do systemd, serviços, kernel e aplicações.",difficulty:"intermediario",timeToRead:"30 min",children:[o.jsxs(e,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",o.jsx("code",{children:"sudo"}),". Já vem instalado junto com systemd. Útil ter visto ",o.jsx("a",{href:"#/systemd",children:"Systemd"}),"."]}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("p",{children:[o.jsx("strong",{children:"journalctl"})," — cliente para ler o journal binário do systemd."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"journal"})," — log estruturado, indexado e binário, mantido pelo ",o.jsx("code",{children:"systemd-journald"}),"."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Persistente vs volátil"})," — sem ",o.jsx("code",{children:"/var/log/journal/"})," os logs morrem no reboot. Crie a pasta para persistir."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Unidade"})," — filtre logs por serviço com ",o.jsx("code",{children:"-u nome.service"}),"."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Prioridades"})," — 0=emerg ... 7=debug. Filtre com ",o.jsx("code",{children:"-p err"}),"."]}),o.jsxs("p",{children:["O ",o.jsx("strong",{children:"journalctl"})," é a ferramenta para acessar os logs do systemd journal, o sistema centralizado de logs do Ubuntu. Ele captura logs do kernel, serviços systemd, aplicações e mensagens do sistema em um formato estruturado e indexado, permitindo buscas rápidas e filtros poderosos."]}),o.jsx("h2",{children:"1. Visualizar Logs"}),o.jsx(r,{title:"Comandos básicos do journalctl",code:`# Ver todos os logs (do mais antigo ao mais recente)
  journalctl
  ...
  journalctl -o short-precise  # Com microssegundos`}),o.jsx("h2",{children:"2. Filtrar por Serviço/Unidade"}),o.jsx(r,{title:"Filtrar logs por serviço systemd",code:`# Logs de um serviço específico
  journalctl -u nginx
  journalctl -u ssh
  ...
  # Logs do grupo root
  journalctl _GID=0`}),o.jsx("h2",{children:"3. Filtrar por Tempo"}),o.jsx(r,{title:"Filtrar logs por período",code:`# Logs desde uma data/hora específica
  ...
  journalctl -u ssh --since "30 min ago" -p err`}),o.jsx("h2",{children:"4. Filtrar por Prioridade"}),o.jsx(r,{title:"Filtrar por nível de severidade",code:`# O journalctl usa os níveis de prioridade syslog:
  ...
  journalctl -p err --since today -o json | grep -o '"_SYSTEMD_UNIT":"[^"]*"' | sort | uniq -c | sort -rn`}),o.jsx("h2",{children:"5. Pesquisa e Grep"}),o.jsx(r,{title:"Buscar texto nos logs",code:`# Buscar por texto (grep integrado)
  journalctl -g "error"
  ...
  # Ou pelo ID:
  journalctl CONTAINER_ID=abc123`}),o.jsx("h2",{children:"6. Gerenciar o Tamanho dos Logs"}),o.jsx(r,{title:"Controlar espaço em disco usado pelo journal",code:`# Ver quanto espaço os logs ocupam
  ...
  sudo journalctl --rotate`}),o.jsx("h2",{children:"7. Logs de Aplicações Específicas"}),o.jsx(r,{title:"Acessar logs de serviços comuns",code:`# === SSH / Login ===
  ...
  journalctl -u systemd-networkd`}),o.jsx("h2",{children:"Troubleshooting"}),o.jsx(r,{title:"Diagnosticar problemas com journalctl",code:`# O servidor reiniciou sozinho — por quê?
  ...
  journalctl -u nginx -p err --since today > nginx-errors.txt`}),o.jsxs(e,{type:"info",title:"journalctl vs arquivos de log tradicionais",children:["O journalctl centraliza todos os logs, mas muitos serviços ainda escrevem em arquivos tradicionais em ",o.jsx("code",{children:"/var/log/"})," (Nginx, Apache, MySQL). Para esses, use ",o.jsx("code",{children:"tail -f"})," ou ",o.jsx("code",{children:"less"}),". O journal captura stdout/stderr dos serviços systemd automaticamente."]})]})}export{i as default};
