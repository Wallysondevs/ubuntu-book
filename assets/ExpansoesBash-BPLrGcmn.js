import{j as o}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as e}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function c(){return o.jsxs(s,{title:"Expansões do Bash",subtitle:"Guia completo de expansões do shell Bash: variáveis, chaves, til, aritmética, command substitution, globbing e manipulação de strings.",difficulty:"intermediario",timeToRead:"25 min",children:[o.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu com terminal Bash. Útil ter visto ",o.jsx("a",{href:"#/shell-bash",children:"Shell Bash"}),"."]}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("p",{children:[o.jsx("strong",{children:"Expansão"})," — transformação que o Bash faz na linha ",o.jsx("em",{children:"antes"})," de executar o comando."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Brace expansion"})," — ",o.jsx("code",{children:"{1..5}"})," vira ",o.jsx("code",{children:"1 2 3 4 5"}),". Acontece ",o.jsx("em",{children:"antes"})," de tudo."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Tilde expansion"})," — ",o.jsx("code",{children:"~"})," vira ",o.jsx("code",{children:"$HOME"}),"; ",o.jsx("code",{children:"~user"})," vira o home do usuário."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Glob"})," — ",o.jsx("code",{children:"*"}),", ",o.jsx("code",{children:"?"}),", ",o.jsx("code",{children:"[]"})," — casamento de padrões em nomes de arquivos."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Command substitution"})," — ",o.jsx("code",{children:"$(comando)"})," ou ",o.jsx("code",{children:"`comando`"})," — substitui pela saída."]}),o.jsxs("p",{children:["As ",o.jsx("strong",{children:"expansões do Bash"})," são mecanismos que transformam o texto que você digita antes de o comando ser executado. Dominar as expansões permite escrever comandos mais curtos, poderosos e elegantes — desde renomear dezenas de arquivos em uma linha até fazer cálculos e manipular strings diretamente no terminal."]}),o.jsx("h2",{children:"1. Expansão de Chaves (Brace Expansion)"}),o.jsx(e,{title:"Gerar sequências e combinações com {}",code:`# Expansão de listas
  echo {a,b,c}
  # Saída: a b c
  ...
  # Criar meses do ano
  mkdir {01..12}-2024`}),o.jsx("h2",{children:"2. Expansão de Variáveis"}),o.jsx(e,{title:"Manipulação avançada de variáveis",code:`# Expansão básica
  nome="João"
  echo $nome          # João
  ...
  echo \${texto,,}               # hello (tudo minúscula)`}),o.jsx("h2",{children:"3. Command Substitution"}),o.jsx(e,{title:"Usar saída de comandos como valores",code:`# Sintaxe: $(comando) ou \`comando\`
  ...
  echo $((++i))         # 2 (incrementa e retorna)`}),o.jsx("h2",{children:"4. Globbing (Expansão de Nomes de Arquivo)"}),o.jsx(e,{title:"Padrões para selecionar arquivos",code:`# * = qualquer sequência de caracteres (exceto /)
  ls *.txt              # Todos os .txt
  ...
  ls **/*.{js,ts}       # Todos os JS e TS recursivamente`}),o.jsx("h2",{children:"5. Expansão do Til (~)"}),o.jsx(e,{title:"Atalhos com ~",code:`# ~ = diretório home do usuário atual
  echo ~
  # Saída: /home/usuario
  ...
  echo ~-
  cd ~-                 # Voltar ao diretório anterior (mesmo que cd -)`}),o.jsx("h2",{children:"Troubleshooting"}),o.jsx(e,{title:"Problemas comuns com expansões",code:`# Expansão não funciona dentro de aspas simples
  ...
  echo {1..5}
  set +x                # Desativa modo debug`}),o.jsx(a,{type:"info",title:"Ordem das expansões no Bash",children:"O Bash processa as expansões nesta ordem: 1) Brace expansion, 2) Tilde expansion, 3) Parameter/variable expansion, 4) Command substitution, 5) Arithmetic expansion, 6) Word splitting, 7) Pathname expansion (globbing). Entender essa ordem ajuda a prever o comportamento de comandos complexos."})]})}export{c as default};
