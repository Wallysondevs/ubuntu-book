import{j as o}from"./index-EYLSWWbe.js";import{P as s}from"./PageContainer-O-275-bt.js";import{C as e}from"./CodeBlock-BcvkqmKR.js";import{I as a}from"./InfoBox-BCWYYCUg.js";import"./house-DsFxaiGW.js";import"./proxy-BLFgcFJx.js";function u(){return o.jsxs(s,{title:"Gerenciamento de Disco",subtitle:"Guia completo de gerenciamento de disco no Ubuntu: espaço, uso, limpeza, montagem, quotas, SMART e monitoramento.",difficulty:"iniciante",timeToRead:"20 min",children:[o.jsx("p",{children:"Gerenciar o espaço em disco é fundamental para manter o sistema saudável. Disco cheio causa falhas em serviços, travamentos e perda de dados. Este guia cobre como verificar uso, limpar espaço, montar discos e monitorar a saúde."}),o.jsx("h2",{children:"1. Verificar Uso de Disco"}),o.jsx(e,{title:"Comandos para verificar espaço",code:`# Uso de disco por filesystem
  df -h
  ...
  df -ih    # Disco cheio de inodes = muitos arquivos pequenos`}),o.jsx("h2",{children:"2. Limpar Espaço em Disco"}),o.jsx(e,{title:"Liberar espaço no Ubuntu",code:`# === PACOTES ===
  # Limpar cache do apt
  ...
  sudo rm -rf /tmp/*`}),o.jsx("h2",{children:"3. Montar e Desmontar Discos"}),o.jsx(e,{title:"Montar discos e partições",code:`# Montar disco/partição
  ...
  sudo mount -a`}),o.jsx("h2",{children:"4. Saúde do Disco (SMART)"}),o.jsx(e,{title:"Monitorar saúde do disco",code:`# Instalar smartmontools
  ...
  # Alerta por email se disco começar a falhar`}),o.jsx("h2",{children:"Troubleshooting"}),o.jsx(e,{title:"Problemas comuns com disco",code:`# Disco cheio — encontrar o que está usando espaço
...
' | sort | uniq -c | sort -rn | head
  ...
  sudo smartctl -H /dev/sda
  # Verificar I/O:
  iostat -x 1 5`}),o.jsxs(a,{type:"warning",title:"Monitore seus discos",children:["Discos falham sem aviso. Configure o ",o.jsx("code",{children:"smartd"})," para monitoramento automático e faça backups regulares. Se o SMART mostrar setores realocados crescentes, ",o.jsx("strong",{children:"substitua o disco imediatamente"}),"."]})]})}export{u as default};
