import{j as e}from"./index-_kFPLDpE.js";import{P as i}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function d(){return e.jsxs(i,{title:"Wine — Executar Aplicativos Windows no Ubuntu",subtitle:"Guia completo do Wine, Winetricks, Bottles e Proton para rodar programas e jogos Windows nativamente no Ubuntu sem virtualização.",difficulty:"intermediario",timeToRead:"30 min",children:[e.jsxs(o,{type:"info",title:"Pré-requisitos",children:["Ubuntu Desktop, ",e.jsx("code",{children:"sudo"}),". Algumas apps Windows simplesmente não funcionam — verifique no AppDB do Wine antes."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Wine"})," — Wine Is Not an Emulator — implementa a API do Windows no Linux."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Prefix"}),' — pasta com "C:\\\\" virtual. Padrão: ',e.jsx("code",{children:"~/.wine/"}),". Cada app pode ter o seu."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"winetricks"})," — script que automatiza instalação de DLLs e fontes do Windows."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Proton"})," — fork do Wine usado pelo Steam para rodar jogos Windows."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Lutris"})," — frontend que gerencia prefixes e instala jogos automaticamente."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Wine"})," (Wine Is Not an Emulator) é uma camada de compatibilidade que permite executar aplicativos Windows no Linux sem emulação. Diferente de uma máquina virtual, o Wine traduz as chamadas da API do Windows para Linux em tempo real, o que significa performance quase nativa."]}),e.jsx("h2",{children:"Wine vs Máquina Virtual — Quando Usar Cada Um"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Wine"})," — Ideal para aplicativos simples, jogos (via Proton/Lutris), programas de escritório. Performance nativa, sem overhead. Nem todo software funciona."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"VM (VirtualBox/KVM)"})," — Ideal quando você precisa de 100% de compatibilidade, como software empresarial complexo ou drivers de hardware Windows. Mais lento, consome mais recursos."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Bottles/Lutris"})," — Frontends gráficos para o Wine com prefixos isolados. Facilitam a configuração e compatibilidade."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Proton"})," — Versão do Wine otimizada pela Valve para jogos no Steam. Funciona automaticamente no Steam para Linux."]})]}),e.jsx("h2",{children:"1. Instalar o Wine"}),e.jsx(a,{title:"Instalação do Wine no Ubuntu",code:`# Habilitar arquitetura 32-bit (necessário para muitos programas Windows)
