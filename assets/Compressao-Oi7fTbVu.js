import{j as r}from"./index-_kFPLDpE.js";import{P as i}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function c(){return r.jsxs(i,{title:"Compressão e Arquivamento",subtitle:"Guia completo de compressão no Ubuntu: tar, gzip, bzip2, xz, zip, 7z, zstd — criar, extrair, listar e comparar formatos.",difficulty:"iniciante",timeToRead:"20 min",children:[r.jsxs(o,{type:"info",title:"Pré-requisitos",children:["Ubuntu com terminal. ",r.jsx("code",{children:"tar"}),", ",r.jsx("code",{children:"gzip"}),", ",r.jsx("code",{children:"zip"})," já vêm instalados. Para ",r.jsx("code",{children:"7z"}),": ",r.jsx("code",{children:"sudo apt install p7zip-full"}),"."]}),r.jsx("h2",{children:"Glossário rápido"}),r.jsxs("p",{children:[r.jsx("strong",{children:"tar"}),' — "tape archive". Junta vários arquivos em um só (não comprime sozinho).']}),r.jsxs("p",{children:[r.jsx("strong",{children:"gzip / bzip2 / xz / zstd"})," — algoritmos de compressão. ",r.jsx("code",{children:"gzip"})," é rápido; ",r.jsx("code",{children:"xz"})," comprime mais; ",r.jsx("code",{children:"zstd"})," é o moderno equilibrado."]}),r.jsxs("p",{children:[r.jsx("strong",{children:".tar.gz / .tgz"})," — arquivo tar comprimido com gzip. Padrão Linux."]}),r.jsxs("p",{children:[r.jsx("strong",{children:"zip"})," — formato Windows-friendly. Comprime e arquiva em um só passo."]}),r.jsxs("p",{children:["A ",r.jsx("strong",{children:"compressão"})," reduz o tamanho de arquivos para economizar espaço e transferir mais rápido. No Linux, é comum separar ",r.jsx("strong",{children:"arquivamento"}),"(juntar vários arquivos em um — ",r.jsx("code",{children:"tar"}),") da ",r.jsx("strong",{children:"compressão"}),"(reduzir tamanho — ",r.jsx("code",{children:"gzip"}),", ",r.jsx("code",{children:"xz"}),"), mas o ",r.jsx("code",{children:"tar"}),"pode fazer ambos em um comando."]}),r.jsx("h2",{children:"1. tar (Tape Archive)"}),r.jsx(a,{title:"O canivete suíço do arquivamento",code:`# tar combina múltiplos arquivos em um (.tar)
  ...
  tar cf - pasta/ | pv | gzip > backup.tar.gz`}),r.jsx("h2",{children:"2. gzip, bzip2, xz"}),r.jsx(a,{title:"Comprimir arquivos individuais",code:`# gzip (rápido, compressão boa)
  ...
  # bzip2: ~30MB, 8s
  # xz:    ~25MB, 30s
  # zstd:  ~32MB, 0.5s ← mais rápido!`}),r.jsx("h2",{children:"3. zip e 7z"}),r.jsx(a,{title:"Formatos compatíveis com Windows",code:`# === ZIP (universal, compatível com Windows) ===
  ...
  unrar l arquivo.rar              # Listar`}),r.jsx("h2",{children:"Troubleshooting"}),r.jsx(a,{title:"Problemas comuns com compressão",code:`# "tar: Removing leading '/' from member names"
  ...
  tar cf backup.tar pasta-de-videos/`}),r.jsxs(o,{type:"info",title:"Qual formato usar?",children:[r.jsx("strong",{children:"tar.gz"})," — padrão Linux, rápido, bom para backups.",r.jsx("strong",{children:"tar.xz"})," — quando tamanho importa mais que velocidade.",r.jsx("strong",{children:"tar.zst"})," — melhor de dois mundos (rápido + bom ratio).",r.jsx("strong",{children:"zip"})," — quando precisa compartilhar com Windows.",r.jsx("strong",{children:"7z"})," — melhor compressão absoluta."]})]})}export{c as default};
