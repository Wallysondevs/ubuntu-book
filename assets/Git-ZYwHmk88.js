import{j as e}from"./index-_kFPLDpE.js";import{P as o}from"./PageContainer-eafNNqkI.js";import{C as i}from"./CodeBlock-ByIkwE54.js";import{A as t}from"./AlertBox-NzOB7YP7.js";function c(){return e.jsxs(o,{title:"Git — Controle de Versão",subtitle:"Guia completo do Git no Ubuntu: instalar, configurar, branches, merge, rebase, stash, reset, tags, GitHub e workflows profissionais.",difficulty:"iniciante",timeToRead:"35 min",children:[e.jsxs(t,{type:"info",title:"Pré-requisitos",children:["Ubuntu com terminal. Instale com ",e.jsx("code",{children:"sudo apt install git"}),". Útil ter conta no GitHub/GitLab/Bitbucket."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Git"})," — sistema de controle de versão distribuído criado por Linus Torvalds para o kernel Linux."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Repositório"})," — pasta com ",e.jsx("code",{children:".git/"})," dentro — guarda toda a história."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Commit"})," — snapshot atômico do projeto com hash SHA-1 único."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Branch"})," — ponteiro móvel para um commit. ",e.jsx("code",{children:"main"}),"/",e.jsx("code",{children:"master"})," é o padrão."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Remote"})," — repositório em outro lugar (GitHub, servidor próprio). ",e.jsx("code",{children:"origin"})," é o nome padrão."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Git"})," é o sistema de controle de versão mais usado no mundo. Ele rastreia todas as mudanças no seu código, permite colaborar com outros desenvolvedores, reverter para versões anteriores e trabalhar em múltiplas funcionalidades simultaneamente com branches."]}),e.jsx("h2",{children:"1. Instalação e Configuração"}),e.jsx(i,{title:"Instalar e configurar o Git",code:`# Instalar Git
  ...
  # Saída: "Hi usuario! You've successfully authenticated"`}),e.jsx("h2",{children:"2. Operações Básicas"}),e.jsx(i,{title:"Comandos essenciais do dia a dia",code:`# Criar repositório
  ...
  git diff HEAD~3            # Últimos 3 commits`}),e.jsx("h2",{children:"3. Branches"}),e.jsx(i,{title:"Trabalhar com branches",code:`# Criar branch
  ...
  # Renomear branch
  git branch -m nome-antigo nome-novo`}),e.jsx("h2",{children:"4. Merge e Conflitos"}),e.jsx(i,{title:"Resolver conflitos de merge",code:`# Merge: integrar mudanças de outra branch
  git checkout main
  git merge feature/login
  ...
  git rebase -i HEAD~3
  # Permite: squash, reword, reorder, drop commits`}),e.jsx("h2",{children:"5. Stash, Reset e Revert"}),e.jsx(i,{title:"Salvar temporariamente, desfazer mudanças",code:`# === STASH (guardar mudanças temporariamente) ===
  ...
  git cherry-pick abc1234     # Aplica um commit de outra branch`}),e.jsx("h2",{children:"6. Trabalhando com Remotos"}),e.jsx(i,{title:"Push, pull e repositórios remotos",code:`# Ver remotos
  git remote -v
  ...
  *.log
  ...
  dist/
  build/
  EOF`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(i,{title:"Problemas comuns com Git",code:`# Fiz commit na branch errada
  git stash          # Guardar mudanças
  ...
  git pull --rebase
  git push`}),e.jsxs(t,{type:"info",title:"Workflow recomendado",children:["Use ",e.jsx("strong",{children:"Git Flow"})," para projetos grandes (main, develop, feature/*, release/*, hotfix/*) ou ",e.jsx("strong",{children:"GitHub Flow"})," para projetos menores (main + feature branches com Pull Requests). O importante é: nunca commite diretamente na main em equipe — sempre use branches e Pull Requests."]})]})}export{c as default};
