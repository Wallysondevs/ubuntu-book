import{j as s}from"./index-_kFPLDpE.js";import{P as e}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function n(){return s.jsxs(e,{title:"Zsh — Shell Avançado",subtitle:"Instalação do Zsh e Oh My Zsh no Ubuntu: plugins, temas, autocompletar, aliases, histórico e personalização completa do terminal.",difficulty:"iniciante",timeToRead:"25 min",children:[s.jsxs(o,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",s.jsx("code",{children:"sudo"}),". Vamos instalar Zsh + Oh My Zsh."]}),s.jsx("h2",{children:"Glossário rápido"}),s.jsxs("p",{children:[s.jsx("strong",{children:"Zsh"})," — Z shell — shell mais moderno que Bash, com features extras (autocomplete inteligente, glob avançado)."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"Oh My Zsh"})," — framework de configs e plugins para Zsh. Quase obrigatório."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"Powerlevel10k"})," — tema poderoso e rápido — prompt informativo com Git, k8s, etc."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"~/.zshrc"})," — equivalente do ",s.jsx("code",{children:".bashrc"}),"."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"chsh"})," — muda seu shell padrão. ",s.jsx("code",{children:"chsh -s $(which zsh)"}),"."]}),s.jsxs("p",{children:["O ",s.jsx("strong",{children:"Zsh"})," (Z Shell) é um shell avançado compatível com Bash, mas com recursos extras como autocompletar inteligente, correção de erros, globbing avançado e temas visuais. Com o ",s.jsx("strong",{children:"Oh My Zsh"}),", se torna o shell mais produtivo e bonito do Linux."]}),s.jsx("h2",{children:"1. Instalação e Configuração"}),s.jsx(a,{title:"Instalar o Zsh e torná-lo padrão",code:`# Instalar o Zsh
  sudo apt update
  ...
  chsh -s $(which bash)`}),s.jsx("h2",{children:"2. Oh My Zsh — Framework de Configuração"}),s.jsx(a,{title:"Instalar e configurar o Oh My Zsh",code:`# Instalar o Oh My Zsh
  ...
  # No terminal do Ubuntu: Preferências → Perfil → Fonte`}),s.jsx("h2",{children:"3. Plugins Essenciais"}),s.jsx(a,{title:"Instalar e configurar plugins do Oh My Zsh",code:`# Os plugins são ativados no ~/.zshrc:
  ...
  source ~/.zshrc`}),s.jsx("h2",{children:"4. Aliases e Funções"}),s.jsx(a,{title:"Criar aliases e funções personalizadas",code:`# Adicionar aliases ao ~/.zshrc (ou ~/.zsh_aliases)
  # Aliases úteis:
  ...
  }`}),s.jsx("h2",{children:"5. Configurações Avançadas do Zsh"}),s.jsx(a,{title:"Recursos avançados do Zsh",code:`# Histórico compartilhado entre terminais
  # No ~/.zshrc:
  HISTSIZE=50000
  SAVEHIST=50000
  ...
  # Agora: digite "git" e pressione ↑ para navegar entre comandos git anteriores`}),s.jsx("h2",{children:"Troubleshooting"}),s.jsx(a,{title:"Problemas comuns com Zsh",code:`# Terminal lento para abrir (Zsh demora para carregar)
  ...
  omz update
  # Ou manualmente:
  cd ~/.oh-my-zsh && git pull`}),s.jsxs(o,{type:"info",title:"Zsh vs Fish vs Bash",children:[s.jsx("strong",{children:"Bash"})," é o padrão e mais compatível. ",s.jsx("strong",{children:"Zsh"})," é Bash melhorado com plugins (via Oh My Zsh). ",s.jsx("strong",{children:"Fish"})," tem melhor experiência out-of-the-box (autocompletar, cores), mas não é compatível com Bash. Para a maioria dos usuários, Zsh + Oh My Zsh é a melhor combinação."]})]})}export{n as default};
