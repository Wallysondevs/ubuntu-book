import{j as e}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function n(){return e.jsxs(s,{title:"fstab — Montagem de Sistemas de Arquivos",subtitle:"Guia completo do /etc/fstab no Ubuntu: montar partições automaticamente, opções de montagem, UUID, swap e dispositivos removíveis.",difficulty:"intermediario",timeToRead:"25 min",children:[e.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",e.jsx("code",{children:"sudo"}),". Cuidado: erro em ",e.jsx("code",{children:"/etc/fstab"})," pode impedir o boot — sempre tenha um pendrive live por perto. Use ",e.jsx("code",{children:"mount -a"})," para testar antes de reiniciar."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"fstab"})," — file system table — arquivo ",e.jsx("code",{children:"/etc/fstab"})," com partições montadas no boot."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"UUID"})," — identificador único da partição. Sempre prefira UUID a ",e.jsx("code",{children:"/dev/sdaN"})," (que pode mudar)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Mount options"})," — ",e.jsx("code",{children:"defaults"}),", ",e.jsx("code",{children:"noatime"}),", ",e.jsx("code",{children:"ro"}),", ",e.jsx("code",{children:"user"}),", ",e.jsx("code",{children:"nofail"})," — controlam comportamento."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"dump / pass"})," — últimos campos: ",e.jsx("code",{children:"dump"})," (backup, quase sempre 0) e ",e.jsx("code",{children:"pass"})," (ordem do fsck no boot)."]}),e.jsxs("p",{children:["O arquivo ",e.jsx("strong",{children:"/etc/fstab"})," (File System Table) define quais sistemas de arquivos são montados automaticamente no boot do sistema. Cada linha descreve uma partição, disco ou recurso de rede e como ele deve ser montado — ponto de montagem, tipo de filesystem, opções e prioridade."]}),e.jsx("h2",{children:"1. Entender o fstab"}),e.jsx(o,{title:"Estrutura do /etc/fstab",code:`# Ver o fstab atual
  cat /etc/fstab
  ...
  # UUID=xxx  /mnt/externo  ext4  defaults,nofail,x-systemd.device-timeout=5  0  2`}),e.jsxs(a,{type:"info",title:"UUID vs /dev/sdX",children:["Sempre use ",e.jsx("code",{children:"UUID="})," no fstab ao invés de ",e.jsx("code",{children:"/dev/sda1"}),". Os nomes ",e.jsx("code",{children:"/dev/sdX"})," podem mudar quando você adiciona/remove discos, mas o UUID é único e permanente. Use ",e.jsx("code",{children:"sudo blkid"})," para descobrir UUIDs."]})]})}export{n as default};
