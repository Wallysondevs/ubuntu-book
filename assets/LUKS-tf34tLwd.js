import{j as e}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function c(){return e.jsxs(s,{title:"LUKS — Criptografia de Disco no Ubuntu",subtitle:"Guia completo de criptografia de disco com LUKS: criptografar partições, HDs externos, pendrives, gerenciar chaves e recuperação.",difficulty:"avancado",timeToRead:"30 min",children:[e.jsxs(o,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",e.jsx("code",{children:"sudo"}),". Cuidado: criptografar disco existente ",e.jsx("em",{children:"destrói"})," os dados — backup antes! Útil ter visto ",e.jsx("a",{href:"#/disco",children:"Disco"}),"."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"LUKS"})," — Linux Unified Key Setup — padrão de criptografia full-disk no Linux."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"cryptsetup"})," — ferramenta CLI para criar e gerenciar volumes LUKS."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Header"})," — metadados (algoritmo, slots de chave) no início do volume. Backup é vital."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Key slot"})," — LUKS suporta até 8 senhas/keyfiles diferentes para o mesmo volume."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"/etc/crypttab"})," — equivalente do fstab para volumes criptografados — lista o que abrir no boot."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"LUKS"})," (Linux Unified Key Setup) é o padrão de criptografia de disco no Linux. Ele protege seus dados criptografando partições inteiras — se alguém roubar seu notebook ou HD, não consegue ler absolutamente nada sem a senha. O LUKS usa AES-256 por padrão, o mesmo algoritmo usado por governos e militares."]}),e.jsx("h2",{children:"Quando Usar LUKS?"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Notebook/laptop"})," — Se for roubado, seus dados ficam protegidos"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"HD externo/pendrive"})," — Dados sensíveis em mídia portátil"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Servidores"})," — Proteção de dados em repouso (at rest)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Compliance"})," — Exigência de regulamentos como LGPD, GDPR, HIPAA"]})]}),e.jsxs(o,{type:"danger",title:"Backup antes de criptografar",children:["A criptografia de uma partição existente ",e.jsx("strong",{children:"apaga todos os dados"}),". Sempre faça backup completo antes de criptografar. Se você perder a senha e as chaves de recuperação, os dados são irrecuperáveis."]}),e.jsx("h2",{children:"1. Criptografar uma Partição com LUKS"}),e.jsx(a,{title:"Criar partição criptografada",code:`# Instalar ferramentas de criptografia
  ...
  sudo resize2fs /dev/mapper/dados`})]})}export{c as default};
