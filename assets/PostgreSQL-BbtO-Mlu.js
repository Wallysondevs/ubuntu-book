import{j as s}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as e}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function d(){return s.jsxs(a,{title:"PostgreSQL no Ubuntu",subtitle:"Instalação, configuração, gerenciamento de bancos, usuários, backup, replicação, tunning de performance e segurança do PostgreSQL.",difficulty:"intermediario",timeToRead:"35 min",children:[s.jsxs(o,{type:"info",title:"Pré-requisitos",children:["Ubuntu Server/Desktop com ",s.jsx("code",{children:"sudo"}),". SQL básico ajuda. PostgreSQL é mais rigoroso com tipos e SQL-padrão que o MySQL — vale ter paciência se vem do MySQL."]}),s.jsx("h2",{children:"Glossário rápido"}),s.jsxs("p",{children:[s.jsx("strong",{children:"PostgreSQL"})," — banco objeto-relacional open-source, em desenvolvimento ativo desde 1986. Conhecido pelo respeito ao SQL-padrão e por features avançadas (JSONB, CTEs, window functions)."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"Cluster"})," — instância do PostgreSQL com vários bancos. No Ubuntu, gerenciado via ",s.jsx("code",{children:"pg_lsclusters"}),", ",s.jsx("code",{children:"pg_createcluster"}),", ",s.jsx("code",{children:"pg_dropcluster"}),"."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"Role"})," — usuário/grupo (PostgreSQL unifica os dois conceitos)."]}),s.jsxs("p",{children:[s.jsx("strong",{children:"pg_hba.conf"})," — controle de autenticação por host/usuário/banco. O método ",s.jsx("code",{children:"peer"})," usa o usuário do SO; ",s.jsx("code",{children:"md5"}),"/",s.jsx("code",{children:"scram-sha-256"})," usam senha."]}),s.jsxs("p",{children:["O ",s.jsx("strong",{children:"PostgreSQL"})," é o banco de dados relacional open source mais avançado do mundo. Suporta JSON, full-text search, tipos geoespaciais (PostGIS), replicação, particionamento e extensibilidade via extensões. É usado por empresas como Apple, Instagram, Spotify e o governo brasileiro."]}),s.jsx("h2",{children:"1. Instalação"}),s.jsx(e,{title:"Instalar o PostgreSQL no Ubuntu",code:`# Instalar o PostgreSQL (versão dos repositórios do Ubuntu)
  sudo apt update
  ...
  sudo tail -f /var/log/postgresql/postgresql-16-main.log`}),s.jsx(o,{type:"info",title:"PostgreSQL vs MySQL",children:"O PostgreSQL é geralmente preferido para: dados complexos, JSON, full-text search, integridade referencial forte e compliance. O MySQL é mais usado em: hospedagem compartilhada, WordPress, aplicações web simples. Para novos projetos, o PostgreSQL é a escolha mais versátil."})]})}export{d as default};
