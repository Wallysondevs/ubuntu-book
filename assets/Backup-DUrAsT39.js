import{j as o}from"./index-_kFPLDpE.js";import{P as r}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as e}from"./AlertBox-NzOB7YP7.js";function t(){return o.jsxs(r,{title:"Backup com rsync e Estratégias de Backup",subtitle:"Guia completo de backup no Ubuntu: rsync, cron, backup incremental, rotativo, remoto via SSH, estratégia 3-2-1 e restauração.",difficulty:"intermediario",timeToRead:"30 min",children:[o.jsxs(e,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",o.jsx("code",{children:"sudo"}),". Espaço extra (HD externo, NAS, S3, outro servidor SSH) para armazenar o backup. ",o.jsx("code",{children:"rsync"})," já vem instalado."]}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("p",{children:[o.jsx("strong",{children:"Backup completo"})," — copia tudo. Demora mais e ocupa mais espaço."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Incremental"})," — copia só o que mudou desde o último backup."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Diferencial"})," — copia o que mudou desde o último backup completo."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"3-2-1"})," — regra ouro: 3 cópias dos dados, 2 mídias diferentes, 1 fora do site."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"rsync"})," — utilitário que sincroniza diretórios transferindo só o delta. Aceita SSH como transporte."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Backup"})," é a prática mais importante de qualquer administrador de sistema. Sem backup, um disco queimado, um ransomware ou um ",o.jsx("code",{children:"rm -rf"})," acidental pode significar perda total de dados. O ",o.jsx("strong",{children:"rsync"})," é a ferramenta padrão do Linux para backup — eficiente, flexível e confiável."]}),o.jsx("h2",{children:"Estratégia 3-2-1 de Backup"}),o.jsxs("ul",{children:[o.jsxs("li",{children:[o.jsx("strong",{children:"3 cópias"})," dos seus dados (original + 2 backups)"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"2 tipos diferentes"})," de mídia (disco local + nuvem, ou disco + HD externo)"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"1 cópia offsite"})," (em outro local físico — nuvem ou servidor remoto)"]})]}),o.jsxs(e,{type:"danger",title:"Regra de ouro",children:["Um backup que nunca foi testado ",o.jsx("strong",{children:"não é um backup"}),". Sempre teste a restauração regularmente. Muitas empresas descobrem que seus backups estão corrompidos ou incompletos apenas quando precisam deles."]}),o.jsx("h2",{children:"1. rsync — Fundamentos"}),o.jsx(a,{title:"Backup básico com rsync",code:`# Sintaxe básica do rsync
  ...
  rsync -av --exclude='*.tmp' --exclude='.cache' --exclude='node_modules'     /home/usuario/ /backup/usuario/
  ...
  *.log
  ...
  rsync -av --exclude-from=/etc/rsync-excludes.txt /home/usuario/ /backup/`}),o.jsx("h2",{children:"2. Backup Remoto via SSH"}),o.jsx(a,{title:"Backup para servidor remoto com rsync + SSH",code:`# Backup local → servidor remoto
  ...
  # Arquivos que mudaram são copiados normalmente`}),o.jsx("h2",{children:"3. Backup Incremental Rotativo"}),o.jsx(a,{title:"Script de backup rotativo com snapshots",code:`# Script de backup com rotação (mantém últimos 7 backups diários)
  ...
  if [ -n "$LATEST" ]; then
      ...
      rsync -ah --delete --link-dest="$LATEST"           --exclude-from="$EXCLUDES"           "$ORIGEM/" "$BACKUP_DIR/"
  else
      echo "Primeiro backup (completo)"
      rsync -ah --delete           --exclude-from="$EXCLUDES"           "$ORIGEM/" "$BACKUP_DIR/"
  fi
  ...
  # Testar o script
  sudo /usr/local/bin/backup-rotativo.sh`}),o.jsx("h2",{children:"4. Agendar Backups com Cron"}),o.jsx(a,{title:"Automatizar backups com crontab",code:`# Editar o crontab do root
  sudo crontab -e
  ...
  sudo systemctl start backup.timer`}),o.jsx("h2",{children:"5. Backup de Bancos de Dados"}),o.jsx(a,{title:"Backup de MySQL/PostgreSQL",code:`# === MySQL / MariaDB ===
  ...
  # Ou formato custom:
  sudo -u postgres pg_restore -d nome_do_banco banco.dump`}),o.jsx("h2",{children:"6. Ferramentas Alternativas de Backup"}),o.jsx(a,{title:"Outras ferramentas de backup",code:`# === BorgBackup (backup deduplicado e criptografado) ===
  ...
  rclone copy /dados/ remote:dados/`}),o.jsx("h2",{children:"Troubleshooting"}),o.jsx(a,{title:"Problemas comuns com backup",code:`# rsync: "Permission denied"
  ...
  rsync -avhn /backup/documentos/ /home/usuario/documentos/`}),o.jsxs(e,{type:"info",title:"Backup na nuvem",children:["Para backup offsite (fora do local), considere serviços como AWS S3, Backblaze B2, Google Cloud Storage ou Wasabi. O ",o.jsx("code",{children:"rclone"}),"suporta todos eles e pode ser combinado com criptografia via",o.jsx("code",{children:"borg"})," ou ",o.jsx("code",{children:"duplicity"})," para segurança máxima."]})]})}export{t as default};
