import{j as a}from"./index-_kFPLDpE.js";import{P as e}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";function t(){return a.jsxs(e,{title:"Comandos Avançados",subtitle:"awk, sed, find avançado, xargs, cut, tr, jq — processamento de texto e automação de alto nível no terminal.",difficulty:"avancado",timeToRead:"35 min",children:[a.jsxs("p",{children:["Com o domínio dos comandos básicos, é hora de conhecer as ferramentas que separam usuários avançados de iniciantes. ",a.jsx("code",{children:"awk"})," e ",a.jsx("code",{children:"sed"})," são linguagens de processamento de texto poderosas. Combinados com pipes, transformam o terminal em um ambiente de processamento de dados extremamente eficiente."]}),a.jsx("h2",{children:"sed — Editor de Fluxo de Texto"}),a.jsxs("p",{children:["O ",a.jsx("code",{children:"sed"})," (Stream EDitor) processa texto linha por linha, aplicando transformações como substituição, exclusão e inserção."]}),a.jsx(o,{title:"sed: substituição e edição de texto",code:`# Substituição básica (primeira ocorrência por linha)
...
sed -n 's/^Port //p' /etc/ssh/sshd_config`}),a.jsx("h2",{children:"awk — Processamento de Dados Tabulares"}),a.jsxs("p",{children:["O ",a.jsx("code",{children:"awk"})," é uma linguagem de processamento de texto orientada a campos. É ideal para processar arquivos com colunas (logs, CSV, saída de comandos como ",a.jsx("code",{children:"ps"}),")."]}),a.jsx(o,{title:"awk: processando colunas e campos",code:`# Estrutura: awk 'padrão { ação }' arquivo
...
ps aux | awk 'NR>1 {sum += $3} END {print "Média CPU:", sum/NR "%"}'`}),a.jsx("h2",{children:"cut — Extrair Campos de Texto"}),a.jsx(o,{title:"cut: extração de colunas",code:`# Extrair por posição de caractere (1-indexed)
...
ls /etc | grep "\\." | rev | cut -d. -f1 | rev | sort | uniq`}),a.jsx("h2",{children:"tr — Transliterar e Transformar"}),a.jsx(o,{title:"tr: transformando caracteres",code:`# Converter letras minúsculas para maiúsculas
...
'`}),a.jsx("h2",{children:"find Avançado"}),a.jsx(o,{title:"find com critérios complexos",code:`# Encontrar e executar ação (delete sem confirmação — CUIDADO!)
...
find /var/log -name "*.log" -print0 | xargs -0 gzip`}),a.jsx("h2",{children:"sort, uniq e Processamento de Dados"}),a.jsx(o,{title:"Processamento avançado de dados",code:`# Ordenar por múltiplas colunas
...
join -t: -1 1 -2 3 arquivo1.txt arquivo2.txt`}),a.jsx("h2",{children:"jq — Processamento de JSON"}),a.jsx(o,{title:"Processar JSON na linha de comando",code:`# Instalar jq
sudo apt install jq
...
curl -s https://jsonplaceholder.typicode.com/users | \\
    jq -r '.[] | [.name, .email, .company.name] | @csv'`})]})}export{t as default};
