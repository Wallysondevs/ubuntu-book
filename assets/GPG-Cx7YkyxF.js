import{j as a}from"./index-_kFPLDpE.js";import{P as i}from"./PageContainer-eafNNqkI.js";import{C as e}from"./CodeBlock-ByIkwE54.js";import{A as r}from"./AlertBox-NzOB7YP7.js";function p(){return a.jsxs(i,{title:"GPG — Criptografia e Assinatura Digital",subtitle:"Guia completo do GNU Privacy Guard no Ubuntu: gerar chaves, criptografar arquivos, assinar documentos, verificar assinaturas e integrar com Git e email.",difficulty:"avancado",timeToRead:"35 min",children:[a.jsxs(r,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",a.jsx("code",{children:"gpg"})," (já vem instalado). Útil ter um par de chaves gerado para os exemplos."]}),a.jsx("h2",{children:"Glossário rápido"}),a.jsxs("p",{children:[a.jsx("strong",{children:"GPG"})," — GNU Privacy Guard — implementação livre do OpenPGP. Para criptografia e assinatura."]}),a.jsxs("p",{children:[a.jsx("strong",{children:"Par de chaves"})," — chave privada (segredo) + chave pública (compartilhar). Assinaturas usam a privada; criptografia usa a pública do destinatário."]}),a.jsxs("p",{children:[a.jsx("strong",{children:"Keyring"})," — base local de chaves conhecidas. ",a.jsx("code",{children:"~/.gnupg/"}),"."]}),a.jsxs("p",{children:[a.jsx("strong",{children:"Web of Trust"})," — modelo de confiança descentralizado: você assina chaves de quem confia."]}),a.jsxs("p",{children:[a.jsx("strong",{children:"Keyserver"})," — servidor que guarda chaves públicas. Ex.: ",a.jsx("code",{children:"keys.openpgp.org"}),"."]}),a.jsxs("p",{children:["O ",a.jsx("strong",{children:"GPG"})," (GNU Privacy Guard) é a implementação livre do padrão OpenPGP. Ele permite ",a.jsx("em",{children:"criptografar"})," arquivos e mensagens (só o destinatário pode ler),",a.jsx("em",{children:"assinar digitalmente"})," (provar que você é o autor) e ",a.jsx("em",{children:"verificar assinaturas"}),"(confirmar autenticidade). É usado em commits Git assinados, emails seguros, verificação de downloads e gerenciamento de pacotes do apt."]}),a.jsx("h2",{children:"Conceitos Fundamentais"}),a.jsxs("ul",{children:[a.jsxs("li",{children:[a.jsx("strong",{children:"Chave pública"})," — Compartilhada com todos. Usada para criptografar dados para você e verificar suas assinaturas."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"Chave privada"})," — Secreta, nunca compartilhe. Usada para descriptografar dados e criar assinaturas."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"Keyring"}),' — Seu "chaveiro" local com suas chaves e as chaves públicas de outras pessoas.']}),a.jsxs("li",{children:[a.jsx("strong",{children:"Fingerprint"})," — Hash único da chave para verificação (ex: ",a.jsx("code",{children:"A1B2 C3D4 E5F6..."}),")."]}),a.jsxs("li",{children:[a.jsx("strong",{children:"Web of Trust"})," — Sistema descentralizado de confiança onde pessoas assinam as chaves umas das outras."]})]}),a.jsx("h2",{children:"1. Gerar um Par de Chaves"}),a.jsx(e,{title:"Criar chaves GPG",code:`# Verificar se o GPG está instalado (já vem no Ubuntu)
  gpg --version
  ...
  gpg --fingerprint seu@email.com`}),a.jsx("h2",{children:"2. Exportar e Importar Chaves"}),a.jsx(e,{title:"Compartilhar e importar chaves GPG",code:`# Exportar sua chave pública (para enviar a outras pessoas)
  ...
  gpg --delete-secret-key seu@email.com         # Chave privada`}),a.jsx(r,{type:"danger",title:"Proteja sua chave privada",children:"A chave privada é como a senha mestra de toda a sua identidade digital GPG. Se alguém obtiver sua chave privada E sua senha, pode se passar por você, ler suas mensagens criptografadas e assinar documentos em seu nome. Sempre faça backup seguro e use uma senha forte."}),a.jsx("h2",{children:"3. Criptografar e Descriptografar Arquivos"}),a.jsx(e,{title:"Criptografia de arquivos com GPG",code:`# === CRIPTOGRAFIA ASSIMÉTRICA (com chave pública) ===
  ...
  tar xzf pasta.tar.gz`}),a.jsx("h2",{children:"4. Assinar e Verificar Documentos"}),a.jsx(e,{title:"Assinatura digital com GPG",code:`# Assinar um arquivo (cria arquivo separado com a assinatura)
  ...
  # 4. Verifique o hash:
  sha256sum -c SHA256SUMS 2>&1 | grep ubuntu-24.04`}),a.jsx("h2",{children:"5. GPG com Git (Commits Assinados)"}),a.jsx(e,{title:"Assinar commits e tags no Git",code:`# Configurar o Git para usar sua chave GPG
  ...
  # GitLab: Settings → GPG Keys`}),a.jsx("h2",{children:"6. Gerenciar o Chaveiro"}),a.jsx(e,{title:"Administrar chaves GPG",code:`# Editar uma chave (adicionar email, mudar validade, etc.)
  ...
  gpg --import-ownertrust trustdb-backup.txt`}),a.jsx("h2",{children:"Troubleshooting"}),a.jsx(e,{title:"Problemas comuns com GPG",code:`# Erro: "gpg: decryption failed: No secret key"
  ...
  max-cache-ttl 86400
  EOF
  gpgconf --kill gpg-agent`}),a.jsxs(r,{type:"info",title:"GPG no dia a dia",children:['Mesmo que você não use email criptografado, o GPG é útil para: assinar commits no Git (mostra o selo "Verified" no GitHub), criptografar backups sensíveis, verificar downloads e gerenciar senhas com ',a.jsx("code",{children:"pass"})," (gerenciador de senhas baseado em GPG)."]})]})}export{p as default};
