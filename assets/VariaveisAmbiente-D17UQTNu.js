import{j as e}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as r}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function c(){return e.jsxs(a,{title:"Variáveis de Ambiente",subtitle:"Guia completo de variáveis de ambiente no Ubuntu: PATH, HOME, definir, exportar, persistir, .env e boas práticas de configuração.",difficulty:"iniciante",timeToRead:"20 min",children:[e.jsx(o,{type:"info",title:"Pré-requisitos",children:"Ubuntu com terminal Bash."}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Variável de ambiente"})," — par chave=valor herdado por processos filhos. ",e.jsx("code",{children:"printenv"})," lista todas."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"export"})," — marca a variável para ser exportada aos filhos."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"PATH"})," — lista de diretórios onde o shell procura executáveis."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"~/.bashrc vs ~/.profile"})," — ",e.jsx("em",{children:"bashrc"})," roda em cada shell interativo; ",e.jsx("em",{children:"profile"})," só no login."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"/etc/environment"})," — variáveis globais do sistema (formato KEY=value, sem export)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Variáveis de ambiente"})," são valores dinâmicos que afetam o comportamento de processos no sistema. Elas armazenam configurações como caminhos de execução (",e.jsx("code",{children:"PATH"}),"), diretório home (",e.jsx("code",{children:"HOME"}),"), credenciais de APIs e muito mais. Todo programa no Linux herda as variáveis do processo pai."]}),e.jsx("h2",{children:"1. Ver Variáveis de Ambiente"}),e.jsx(r,{title:"Listar e inspecionar variáveis",code:`# Ver todas as variáveis de ambiente
  env
  # Ou: printenv
  ...
  env | grep -i proxy
  env | grep -i path
  env | sort    # Todas, ordenadas`}),e.jsx("h2",{children:"2. Definir Variáveis"}),e.jsx(r,{title:"Criar e exportar variáveis",code:`# Variável local (só no shell atual)
  NOME="Ubuntu"
  echo $NOME    # Ubuntu
  ...
  export PATH="/usr/local/go/bin:$PATH"`}),e.jsx("h2",{children:"3. Persistir Variáveis"}),e.jsx(r,{title:"Tornar variáveis permanentes",code:`# Variáveis definidas no terminal são PERDIDAS ao fechar
  ...
  # EnvironmentFile=/etc/meu-app/config.env`}),e.jsx("h2",{children:"4. Arquivos .env"}),e.jsx(r,{title:"Usar arquivos .env para configuração",code:`# Arquivo .env — padrão para aplicações modernas
  cat > .env << 'EOF'
  ...
  # Ruby    → dotenv gem
  # Docker Compose → lê .env automaticamente`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(r,{title:"Problemas comuns com variáveis",code:`# Variável não está definida
  # Verificar:
  echo $MINHA_VAR
  ...
  bash -xl 2>&1 | grep MINHA_VAR`}),e.jsxs(o,{type:"warning",title:"Segurança de variáveis",children:["Nunca coloque senhas ou chaves de API diretamente no código ou no",e.jsx("code",{children:".bashrc"}),". Use arquivos ",e.jsx("code",{children:".env"})," (adicionados ao",e.jsx("code",{children:".gitignore"}),") ou gerenciadores de secrets como o",e.jsx("strong",{children:"pass"}),", ",e.jsx("strong",{children:"Vault"})," ou variáveis de CI/CD."]})]})}export{c as default};
