import{j as e,T as s}from"./index-_kFPLDpE.js";import{P as t}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as o}from"./AlertBox-NzOB7YP7.js";function c(){return e.jsxs(t,{title:"APT — Gerenciador de Pacotes",subtitle:"O coração do Ubuntu. APT instala, remove, atualiza e gerencia todo o software do sistema com comandos simples e poderosos.",difficulty:"iniciante",timeToRead:"25 min",children:[e.jsxs(o,{type:"info",title:"Pré-requisitos",children:["Ubuntu instalado (qualquer versão LTS ou intermediária). Acesso a um terminal e usuário com permissão ",e.jsx("code",{children:"sudo"}),". Não precisa saber gerenciar pacotes — vamos do zero."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Pacote"})," — arquivo ",e.jsx("code",{children:".deb"})," empacotado com binários, libs, configs e metadados. Ubuntu/Debian distribuem todo software como pacotes."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Repositório"})," — servidor que hospeda pacotes. ",e.jsx("code",{children:"/etc/apt/sources.list"}),"e arquivos em ",e.jsx("code",{children:"/etc/apt/sources.list.d/"})," listam quais repositórios o APT consulta."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Dependência"})," — outro pacote que o seu pacote precisa para funcionar. APT resolve dependências automaticamente; ",e.jsx("code",{children:"dpkg"})," não."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Cache APT"})," — banco local em ",e.jsx("code",{children:"/var/lib/apt/lists/"})," com a lista de pacotes disponíveis. ",e.jsx("code",{children:"apt update"})," renova esse cache."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"APT"})," (Advanced Package Tool) é o gerenciador de pacotes do Ubuntu e de todas as distribuições baseadas em Debian. Ele é responsável por instalar, remover e atualizar software, resolvendo dependências automaticamente. Com um único comando, você pode instalar um aplicativo completo com todas as bibliotecas que ele precisa."]}),e.jsx("h2",{children:"Os Comandos: apt vs apt-get"}),e.jsxs("p",{children:["Você vai encontrar dois comandos na documentação: ",e.jsx("code",{children:"apt"})," e ",e.jsx("code",{children:"apt-get"}),". O ",e.jsx("code",{children:"apt"})," é a versão moderna, com saída mais amigável e barra de progresso. O ",e.jsx("code",{children:"apt-get"})," é o clássico, mais estável para scripts. Para uso no terminal do dia a dia, use sempre ",e.jsx("code",{children:"apt"}),"."]}),e.jsxs(o,{type:"info",title:"O que é uma flag (parâmetro)?",children:["Flags são instruções extras passadas a um comando, sempre precedidas por ",e.jsx("code",{children:"-"}),"(flag curta, uma letra) ou ",e.jsx("code",{children:"--"})," (flag longa, palavra completa). Exemplo: ",e.jsx("code",{children:"apt install -y nginx"})," — o ",e.jsx("code",{children:"-y"})," é a flag, o ",e.jsx("code",{children:"nginx"}),"é o pacote. Flags modificam o comportamento do comando."]}),e.jsx("h2",{children:"1. Atualização do Sistema"}),e.jsx(a,{title:"Manter o sistema atualizado",code:`# PASSO 1: Atualizar a LISTA de pacotes disponíveis
sudo apt update
...
apt list --upgradable`}),e.jsx("p",{children:"Rodando de verdade, a saída fica assim:"}),e.jsx(s,{title:"wallyson@ubuntu: ~",lines:[{type:"cmd",text:"sudo apt update && sudo apt upgrade -y"},{type:"out",text:"[sudo] senha para wallyson:"},{type:"out",text:"Atingido:1 http://br.archive.ubuntu.com/ubuntu resolute InRelease"},{type:"out",text:"Obter:2 http://security.ubuntu.com/ubuntu resolute-security InRelease [126 kB]"},{type:"out",text:"Baixados 126 kB em 1s (98,7 kB/s)"},{type:"out",text:"Lendo listas de pacotes... Pronto"},{type:"out",text:"Os seguintes pacotes serao atualizados:"},{type:"out",text:"  firefox libssl3 python3.13 systemd tzdata (42 no total)"},{type:"ok",text:"42 atualizados, 0 novos, 0 a remover. 187 MB de arquivos."},{type:"ok",text:"Sistema atualizado com sucesso."}]}),e.jsxs(o,{type:"danger",title:"Sempre faça apt update antes de instalar",children:["Se você rodar ",e.jsx("code",{children:"sudo apt install alguma-coisa"})," sem antes fazer",e.jsx("code",{children:"sudo apt update"}),", pode instalar uma versão desatualizada do pacote ou receber erros de dependência. Sempre atualize a lista primeiro."]}),e.jsx("h2",{children:"2. Instalação de Pacotes"}),e.jsx(a,{title:"Instalar software com apt",code:`# Instalar um único pacote
...
# Pacotes recomendados são opcionais — sem esta flag, o apt os instala automaticamente`}),e.jsx("p",{children:"Na prática, incluindo quando dá errado:"}),e.jsx(s,{title:"wallyson@ubuntu: ~",lines:[{type:"cmd",text:"sudo apt install htop"},{type:"out",text:"Lendo listas de pacotes... Pronto"},{type:"out",text:"Os NOVOS pacotes a seguir serao instalados:"},{type:"out",text:"  htop"},{type:"out",text:"0 atualizados, 1 novos instalados, 0 a remover."},{type:"ok",text:"Configurando htop (3.3.0-1) ... ok"},{type:"comment",text:"# erro comum 1 — nome de pacote errado:"},{type:"cmd",text:"sudo apt install htopp"},{type:"err",text:"E: Impossivel encontrar o pacote htopp"},{type:"warn",text:"-> digitou errado. Use 'apt search htop' para achar o nome certo."},{type:"comment",text:"# erro comum 2 — o dpkg travado por outro processo:"},{type:"cmd",text:"sudo apt install nginx"},{type:"err",text:"E: Nao foi possivel obter trava /var/lib/dpkg/lock-frontend"},{type:"err",text:"   Em uso pelo processo unattended-upgr (pid 1423)"},{type:"warn",text:"-> o Ubuntu esta aplicando updates automaticos. Espere e tente de novo."}]}),e.jsx("h2",{children:"3. Busca e Informações"}),e.jsx(a,{title:"Pesquisar e inspecionar pacotes",code:`# Buscar pacotes pelo nome ou pela descrição
apt search vlc
...
sudo dpkg-reconfigure locales    # Reconfigurar idioma do sistema`})]})}export{c as default};
