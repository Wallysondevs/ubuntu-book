import{j as o}from"./index-_kFPLDpE.js";import{P as d}from"./PageContainer-eafNNqkI.js";import{C as s}from"./CodeBlock-ByIkwE54.js";import{A as e}from"./AlertBox-NzOB7YP7.js";function n(){return o.jsxs(d,{title:"LVM — Gerenciamento de Volumes Lógicos",subtitle:"Guia completo de LVM no Ubuntu: criar, redimensionar, snapshots, migrar dados entre discos e gerenciar armazenamento flexível.",difficulty:"avancado",timeToRead:"30 min",children:[o.jsxs(e,{type:"info",title:"Pré-requisitos",children:["Ubuntu Server (LVM raramente em Desktop), ",o.jsx("code",{children:"sudo"}),", ao menos um disco/partição livre para experimentar. Útil ter feito ",o.jsx("a",{href:"#/disco",children:"Disco"})," e ",o.jsx("a",{href:"#/particoes",children:"Partições"}),"."]}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("p",{children:[o.jsx("strong",{children:"PV (Physical Volume)"})," — disco/partição física registrada no LVM (",o.jsx("code",{children:"/dev/sda2"})," vira PV)."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"VG (Volume Group)"}),' — pool de PVs. É a "piscina" de espaço total.']}),o.jsxs("p",{children:[o.jsx("strong",{children:"LV (Logical Volume)"})," — volume lógico criado dentro de uma VG. Você formata e monta como se fosse uma partição."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Snapshot"})," — cópia point-in-time de um LV. Útil para backup consistente sem parar o serviço."]}),o.jsxs("p",{children:["O ",o.jsx("strong",{children:"LVM"})," (Logical Volume Manager) adiciona uma camada de abstração entre discos físicos e sistemas de arquivos. Com LVM, você pode redimensionar partições sem desmontar, combinar múltiplos discos em um único volume, criar snapshots e migrar dados entre discos — tudo sem parar o sistema."]}),o.jsx("h2",{children:"Conceitos do LVM"}),o.jsxs("ul",{children:[o.jsxs("li",{children:[o.jsx("strong",{children:"PV (Physical Volume)"})," — Disco ou partição física preparada para LVM"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"VG (Volume Group)"})," — Pool de armazenamento formado por um ou mais PVs"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"LV (Logical Volume)"}),' — "Partição virtual" criada dentro de um VG']})]}),o.jsx("h2",{children:"1. Criar Infraestrutura LVM"}),o.jsx(s,{title:"Configurar LVM do zero",code:`# Instalar ferramentas LVM
  ...
  sudo lsblk
  sudo pvs && sudo vgs && sudo lvs`}),o.jsxs(e,{type:"info",title:"Quando usar LVM?",children:["Use LVM em ",o.jsx("strong",{children:"servidores"})," (redimensionar sem downtime), quando tem",o.jsx("strong",{children:"múltiplos discos"})," (combinar em um pool), e quando precisa de",o.jsx("strong",{children:"snapshots"}),". Para desktops simples com um único SSD, partições tradicionais são suficientes."]})]})}export{n as default};
