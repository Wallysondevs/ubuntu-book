import{j as e,T as o}from"./index-_kFPLDpE.js";import{P as r}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as s}from"./AlertBox-NzOB7YP7.js";function c(){return e.jsxs(r,{title:"SSH - Secure Shell",subtitle:"Conecte-se a servidores remotos com segurança, gerencie chaves, configure o servidor SSH, firewall (UFW) e domine tunneling e transferência de arquivos no Ubuntu.",difficulty:"intermediario",timeToRead:"45 min",children:[e.jsxs(s,{type:"info",title:"Pré-requisitos",children:["Ubuntu (cliente). Outra máquina/servidor com SSH para conectar (pode ser uma VM, Raspberry Pi, VPS ou contêiner). Conhecer terminal básico e ter ",e.jsx("code",{children:"sudo"}),"."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"SSH (Secure Shell)"})," — protocolo de conexão remota criptografada. Substitui telnet/rlogin. Porta padrão 22 (TCP)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Chave pública/privada"})," — par de arquivos que substitui senhas. A pública (",e.jsx("code",{children:"id_ed25519.pub"}),") vai no servidor; a privada fica no seu PC e nunca sai."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"known_hosts"})," — arquivo em ",e.jsx("code",{children:"~/.ssh/"})," que guarda a impressão digital dos servidores conhecidos. Evita ataques man-in-the-middle."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"SSH agent"})," — processo que mantém suas chaves descriptografadas em memória. Você digita a senha da chave uma vez por sessão."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Tunneling / Port forwarding"})," — redireciona uma porta local através do SSH. Útil para acessar bancos privados, Redis, painéis admin atrás de firewall."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"SSH (Secure Shell)"})," é o protocolo padrão para acesso remoto seguro a sistemas Linux. Toda comunicação é criptografada, tornando-o seguro mesmo em redes públicas. No Ubuntu, o servidor SSH é fornecido pelo pacote ",e.jsx("code",{children:"openssh-server"})," e o cliente pelo"," ",e.jsx("code",{children:"openssh-client"})," (já instalado por padrão na maioria dos sistemas Ubuntu Desktop)."]}),e.jsx("h2",{children:"1. Instalação do OpenSSH"}),e.jsx("p",{children:"No Ubuntu, o cliente SSH já vem instalado. O servidor precisa ser instalado separadamente."}),e.jsx(a,{title:"Instalando o OpenSSH no Ubuntu",code:`# Atualizar repositórios antes de instalar
sudo apt update
...
ssh -o ServerAliveInterval=60 usuario@servidor.exemplo.com`}),e.jsx("p",{children:"Conectando de verdade — e os dois erros mais comuns de SSH:"}),e.jsx(o,{title:"wallyson@ubuntu: ~",lines:[{type:"cmd",text:"ssh deploy@203.0.113.10"},{type:"out",text:"The authenticity of host '203.0.113.10' cant be established."},{type:"out",text:"ED25519 key fingerprint is SHA256:9x2a...  Are you sure? (yes/no) yes"},{type:"ok",text:"Welcome to Ubuntu 26.04 LTS (GNU/Linux 7.0 x86_64)"},{type:"comment",text:"# erro 1 — sua chave nao esta autorizada no servidor:"},{type:"cmd",text:"ssh deploy@203.0.113.10"},{type:"err",text:"deploy@203.0.113.10: Permission denied (publickey)."},{type:"warn",text:"-> envie sua chave publica: ssh-copy-id deploy@203.0.113.10"},{type:"comment",text:"# erro 2 — o servico SSH esta fora do ar ou porta errada:"},{type:"cmd",text:"ssh deploy@203.0.113.10"},{type:"err",text:"ssh: connect to host 203.0.113.10 port 22: Connection refused"},{type:"warn",text:"-> o sshd nao esta rodando ou usa outra porta. Veja systemctl e UFW."}]}),e.jsx("h2",{children:"3. Geração de Chaves SSH"}),e.jsxs("p",{children:["Autenticar com chaves SSH é mais seguro e prático do que usar senhas. O par de chaves consiste em uma ",e.jsx("strong",{children:"chave privada"})," (fica no seu computador) e uma ",e.jsx("strong",{children:"chave pública"}),"(é copiada para o servidor)."]}),e.jsx("h3",{children:"ssh-keygen — Criar par de chaves"}),e.jsx(a,{title:"Gerando chaves SSH",code:`# Gerar chave Ed25519 (recomendada — moderna e segura)
