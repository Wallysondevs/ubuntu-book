import{j as o,T as r}from"./index-_kFPLDpE.js";import{P as a}from"./PageContainer-eafNNqkI.js";import{C as e}from"./CodeBlock-ByIkwE54.js";import{A as s}from"./AlertBox-NzOB7YP7.js";function p(){return o.jsxs(a,{title:"Gerenciamento de Processos",subtitle:"Guia completo de processos no Ubuntu: ps, top, htop, kill, nice, jobs, sinais, prioridade e monitoramento avançado.",difficulty:"iniciante",timeToRead:"25 min",children:[o.jsx(s,{type:"info",title:"Pré-requisitos",children:"Ubuntu com terminal. Comandos básicos não exigem sudo; matar processos de outro usuário sim."}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("p",{children:[o.jsx("strong",{children:"Processo"})," — instância em execução de um programa. Cada um tem PID único."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"PID / PPID"})," — process ID e parent process ID. PID 1 é o init (systemd no Ubuntu)."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"ps / top / htop"})," — listar processos. ",o.jsx("code",{children:"htop"})," é interativo e colorido (",o.jsx("code",{children:"sudo apt install htop"}),")."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Sinal"})," — mensagem para o processo: ",o.jsx("code",{children:"SIGTERM"})," pede para encerrar, ",o.jsx("code",{children:"SIGKILL"})," mata sem dó."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"nice / renice"})," — ajusta prioridade do scheduler. -20 = mais prioridade, 19 = menos."]}),o.jsxs("p",{children:["Todo programa em execução no Linux é um ",o.jsx("strong",{children:"processo"}),". Cada processo tem um ",o.jsx("strong",{children:"PID"})," (Process ID) único, um dono, prioridade e consome recursos (CPU, memória, I/O). Saber gerenciar processos é essencial para manter o sistema responsivo e resolver problemas de performance."]}),o.jsx("h2",{children:"1. Ver Processos (ps)"}),o.jsx(e,{title:"Listar processos em execução",code:`# Ver seus processos
  ps
  ...
  nmon                     # Monitor IBM (sudo apt install nmon)`}),o.jsx("p",{children:"Localizando e encerrando um processo — e o erro quando falta permissão:"}),o.jsx(r,{title:"wallyson@ubuntu: ~",lines:[{type:"cmd",text:"ps aux | grep firefox"},{type:"out",text:"wallyson  4821  8.4  3.1  /usr/lib/firefox/firefox"},{type:"out",text:"wallyson  4990  0.0  0.0  grep --color=auto firefox"},{type:"cmd",text:"kill 4821"},{type:"ok",text:"(processo 4821 encerrado)"},{type:"comment",text:"# tentando matar um processo de outro dono (root):"},{type:"cmd",text:"kill 812"},{type:"err",text:"bash: kill: (812) - Operacao nao permitida"},{type:"warn",text:"-> processos de outro usuario exigem privilegio: sudo kill 812"}]}),o.jsx("h2",{children:"3. Sinais e Kill"}),o.jsx(e,{title:"Enviar sinais a processos",code:`# Listar todos os sinais
  kill -l
  ...
  sudo lsof /var/log/syslog`}),o.jsxs(s,{type:"info",title:"Sinais: SIGTERM vs SIGKILL",children:["Sempre use ",o.jsx("code",{children:"kill"})," (SIGTERM) primeiro — ele permite que o processo salve dados e limpe recursos. Só use ",o.jsx("code",{children:"kill -9"})," (SIGKILL) como",o.jsx("strong",{children:"último recurso"})," — ele mata instantaneamente sem dar chance de cleanup, podendo causar corrupção de dados."]})]})}export{p as default};
