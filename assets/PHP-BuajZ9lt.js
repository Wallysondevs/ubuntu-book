import{j as e}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function n(){return e.jsxs(s,{title:"PHP no Ubuntu — LAMP & LEMP Stack",subtitle:"Instalação completa do PHP, configuração com Apache (LAMP) e Nginx (LEMP), extensões, PHP-FPM, Composer e deploy de aplicações PHP.",difficulty:"intermediario",timeToRead:"35 min",children:[e.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",e.jsx("code",{children:"sudo"}),". Útil ter visto ",e.jsx("a",{href:"#/apache",children:"Apache"})," ou ",e.jsx("a",{href:"#/nginx",children:"Nginx"})," se for rodar via web."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"PHP"})," — linguagem de scripting voltada para web, executada no servidor."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"PHP-FPM"})," — FastCGI Process Manager — recomendado em produção (com Nginx ou Apache event)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"mod_php"})," — módulo Apache que roda PHP no mesmo processo (mais simples, menos performático)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Ondrej PPA"})," — PPA mais usado para múltiplas versões PHP no Ubuntu (",e.jsx("code",{children:"ppa:ondrej/php"}),")."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"composer"})," — gerenciador de pacotes PHP — equivalente ao npm/pip."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"PHP"})," é uma das linguagens mais utilizadas para desenvolvimento web, alimentando mais de 75% dos sites do mundo, incluindo WordPress, Laravel, Drupal e Magento. No Ubuntu, o PHP pode ser configurado com Apache (stack LAMP) ou Nginx (stack LEMP), cada um com vantagens diferentes."]}),e.jsx("h2",{children:"LAMP vs LEMP — Qual Escolher?"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"LAMP"})," (Linux + Apache + MySQL + PHP) — Mais tradicional, configuração mais simples via ",e.jsx("code",{children:".htaccess"}),", ideal para hospedagem compartilhada e WordPress."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"LEMP"}),' (Linux + Nginx + MySQL + PHP) — Mais performático, usa menos memória, melhor para sites de alto tráfego. O "E" vem da pronúncia de Nginx ("Engine-X").']})]}),e.jsxs(a,{type:"info",title:"Qual usar?",children:["Para a maioria dos projetos modernos, o LEMP (Nginx + PHP-FPM) é a melhor escolha. Se você vai rodar WordPress ou precisa de compatibilidade com ",e.jsx("code",{children:".htaccess"}),", o LAMP (Apache) pode ser mais conveniente."]}),e.jsx("h2",{children:"1. Instalar o PHP"}),e.jsx(o,{title:"Instalação básica do PHP",code:`# Atualizar repositórios
  sudo apt update
  ...
  # Loaded Configuration File: /etc/php/8.3/cli/php.ini`}),e.jsx("h2",{children:"2. Instalar Extensões PHP"}),e.jsx(o,{title:"Extensões essenciais do PHP",code:`# Extensões para desenvolvimento web geral
  ...
  sudo apt install -y php-xml php-mbstring php-curl php-zip php-bcmath     php-mysql php-pgsql php-redis php-gd php-intl

  # Extensões para WordPress
  sudo apt install -y php-mysql php-xml php-mbstring php-curl     php-gd php-zip php-imagick php-intl
  ...
  sudo systemctl restart php8.3-fpm  # Reiniciar o PHP-FPM após mudanças`}),e.jsx("h2",{children:"3. LAMP Stack — PHP com Apache"}),e.jsx(o,{title:"Configurar LAMP (Apache + PHP)",code:`# Instalar Apache + PHP módulo Apache + MySQL
  ...
  sudo systemctl reload apache2`}),e.jsx("h2",{children:"4. LEMP Stack — PHP com Nginx"}),e.jsx(o,{title:"Configurar LEMP (Nginx + PHP-FPM)",code:`# Instalar Nginx + PHP-FPM + MySQL
  ...
  # Reiniciar o Nginx
  sudo systemctl reload nginx`}),e.jsxs(a,{type:"danger",title:"Nunca exponha o .env",children:["Frameworks como Laravel usam um arquivo ",e.jsx("code",{children:".env"})," com senhas e chaves de API. Certifique-se de que o ",e.jsx("code",{children:"root"})," do Nginx/Apache aponta para a pasta",e.jsx("code",{children:"public/"}),", nunca para a raiz do projeto. A regra de bloqueio de arquivos ocultos também é essencial."]}),e.jsx("h2",{children:"5. Configurar o PHP-FPM"}),e.jsx(o,{title:"Otimizar o PHP-FPM",code:`# Editar a configuração do pool padrão
  ...
  sudo systemctl status php8.3-fpm
  ps aux | grep php-fpm`}),e.jsx("h2",{children:"6. Composer — Gerenciador de Dependências"}),e.jsx(o,{title:"Instalar e usar o Composer",code:`# Instalar o Composer globalmente
  ...
  composer clear-cache`}),e.jsx("h2",{children:"7. Instalar Versões Múltiplas do PHP"}),e.jsx(o,{title:"Múltiplas versões do PHP via PPA",code:`# Adicionar o repositório Ondrej (mantém todas as versões do PHP)
  ...
  sudo a2enmod php8.3
  sudo systemctl restart apache2`}),e.jsx("h2",{children:"8. Xdebug — Depuração de PHP"}),e.jsx(o,{title:"Instalar e configurar o Xdebug",code:`# Instalar o Xdebug
  ...
  sudo systemctl restart php8.3-fpm`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(o,{title:"Problemas comuns com PHP no Ubuntu",code:`# Erro: "PHP Fatal error: Allowed memory size exhausted"
  ...
  sudo find /var/www/meu-projeto -type f -exec chmod 644 {} ;`}),e.jsx(a,{type:"info",title:"PHP em 2024+",children:"O PHP moderno (8.x) tem tipagem forte opcional, fibers (async), JIT compiler e performance comparável a muitas linguagens compiladas. Se você parou de usar PHP na versão 5.x, vale a pena revisitar — a linguagem evoluiu significativamente."})]})}export{n as default};
