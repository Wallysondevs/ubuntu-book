import{j as e}from"./index-_kFPLDpE.js";import{P as i}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function d(){return e.jsxs(i,{title:"Cloud-Init — Provisionamento Automático",subtitle:"Guia completo do Cloud-Init no Ubuntu: configuração automática de servidores, user-data, network config, scripts de inicialização e debug.",difficulty:"avancado",timeToRead:"30 min",children:[e.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Imagem Ubuntu Cloud (já vem com cloud-init). Útil ter conta na cloud (AWS/GCP/Azure/DigitalOcean) ou usar localmente com ",e.jsx("code",{children:"cloud-localds"}),"."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"cloud-init"})," — padrão de inicialização para imagens cloud. Lê metadados na primeira boot e configura usuários, SSH, pacotes, scripts."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"user-data"})," — YAML que você passa para a VM dizendo o que fazer na primeira boot."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"datasource"})," — de onde o cloud-init lê os metadados (EC2, NoCloud, OpenStack, etc.)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"#cloud-config"})," — primeira linha obrigatória do user-data YAML."]}),e.jsxs("p",{children:["O ",e.jsx("strong",{children:"Cloud-Init"})," é a ferramenta padrão para provisionamento automático de instâncias em nuvem. Quando você cria uma VM na AWS, Google Cloud, Azure, DigitalOcean ou qualquer provedor de nuvem, é o Cloud-Init que configura hostname, cria usuários, instala pacotes, configura rede e executa scripts na primeira inicialização."]}),e.jsx("h2",{children:"Como o Cloud-Init Funciona"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Detect"})," — Detecta em qual nuvem está rodando (AWS, GCP, Azure, etc.)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Init"})," — Configura rede, hostname, monta discos"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Config"})," — Cria usuários, instala pacotes, escreve arquivos"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Final"})," — Executa scripts, reboota se necessário"]})]}),e.jsx("h2",{children:"1. Conceitos e Verificação"}),e.jsx(o,{title:"Verificar e entender o Cloud-Init",code:`# Verificar se o Cloud-Init está instalado
  cloud-init --version
  ...
  # Verificar saída:
  cat /var/log/cloud-init-output.log`}),e.jsxs(a,{type:"info",title:"Cloud-Init e Terraform",children:["O Cloud-Init é frequentemente usado com ",e.jsx("strong",{children:"Terraform"})," e",e.jsx("strong",{children:"Ansible"}),". O Terraform cria a infraestrutura (VMs, redes, discos) e passa o user-data do Cloud-Init para o provisionamento inicial. Depois, o Ansible pode ser usado para configurações mais complexas."]})]})}export{d as default};
