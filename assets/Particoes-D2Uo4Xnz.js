import{j as e}from"./index-_kFPLDpE.js";import{P as o}from"./PageContainer-eafNNqkI.js";import{C as s}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function n(){return e.jsxs(o,{title:"Partições e Sistemas de Arquivos",subtitle:"Guia completo de particionamento no Ubuntu: fdisk, parted, gdisk, criar/redimensionar partições, GPT vs MBR, ext4, Btrfs e XFS.",difficulty:"intermediario",timeToRead:"30 min",children:[e.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",e.jsx("code",{children:"sudo"}),". Cuidado ",e.jsx("strong",{children:"extremo"}),": ferramentas de particionamento podem destruir dados — sempre teste em VM ou disco vazio. Útil ter visto ",e.jsx("a",{href:"#/disco",children:"Disco"}),"."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Tabela de partições"})," — MBR (legado, máx 2 TB, 4 primárias) ou GPT (moderno, ilimitada)."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Partição primária / estendida / lógica"}),' — conceitos do MBR. GPT só tem partições "comuns".']}),e.jsxs("p",{children:[e.jsx("strong",{children:"parted / gdisk / fdisk"})," — ferramentas CLI. ",e.jsx("code",{children:"fdisk"})," agora suporta GPT também."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"mkfs"})," — formata uma partição com um filesystem (",e.jsx("code",{children:"mkfs.ext4"}),", ",e.jsx("code",{children:"mkfs.xfs"}),")."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Particionamento"})," é o processo de dividir um disco em seções independentes, cada uma com seu próprio sistema de arquivos. Entender partições é essencial para instalar o Ubuntu, configurar dual boot, gerenciar discos adicionais e otimizar o armazenamento do servidor."]}),e.jsx("h2",{children:"1. Conceitos Fundamentais"}),e.jsx(s,{title:"Tabelas de partição e sistemas de arquivos",code:`# === TABELAS DE PARTIÇÃO ===
  ...
  # TestDisk pode recuperar partições deletadas!`}),e.jsxs(a,{type:"info",title:"Layout de partições recomendado",children:["Para desktop: partição ",e.jsx("code",{children:"/"})," (root, 50-100GB), ",e.jsx("code",{children:"/home"}),"(restante), swap (RAM×1 ou 4-8GB). Para servidor: ",e.jsx("code",{children:"/"})," (20-50GB),",e.jsx("code",{children:"/var"})," (logs e dados), ",e.jsx("code",{children:"/home"})," (se aplicável), swap. Separar ",e.jsx("code",{children:"/home"})," permite reinstalar o sistema sem perder dados pessoais."]})]})}export{n as default};
