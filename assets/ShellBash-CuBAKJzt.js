import{j as o}from"./index-_kFPLDpE.js";import{P as e}from"./PageContainer-eafNNqkI.js";import{C as a}from"./CodeBlock-ByIkwE54.js";import{A as r}from"./AlertBox-NzOB7YP7.js";function n(){return o.jsxs(e,{title:"Shell Bash — O Terminal do Ubuntu",subtitle:"Guia completo do Bash: atalhos, histórico, expansões, globbing, jobs, personalização do prompt e recursos avançados do shell.",difficulty:"iniciante",timeToRead:"25 min",children:[o.jsxs(r,{type:"info",title:"Pré-requisitos",children:["Ubuntu com terminal aberto (",o.jsx("kbd",{children:"Ctrl"}),"+",o.jsx("kbd",{children:"Alt"}),"+",o.jsx("kbd",{children:"T"}),")."]}),o.jsx("h2",{children:"Glossário rápido"}),o.jsxs("p",{children:[o.jsx("strong",{children:"Shell"})," — programa que interpreta seus comandos. Bash é o padrão do Ubuntu."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Prompt"})," — o que o shell desenha esperando comando. Geralmente ",o.jsx("code",{children:"usuario@host:caminho$"}),"."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Built-in"})," — comando interno do shell (",o.jsx("code",{children:"cd"}),", ",o.jsx("code",{children:"echo"}),", ",o.jsx("code",{children:"export"}),") — não vira processo separado."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Histórico"})," — ",o.jsx("code",{children:"history"})," + ",o.jsx("kbd",{children:"Ctrl"}),"+",o.jsx("kbd",{children:"R"})," para busca incremental."]}),o.jsxs("p",{children:[o.jsx("strong",{children:"Tab completion"})," — ",o.jsx("kbd",{children:"Tab"})," autocompleta comandos, paths e até argumentos quando o pacote ",o.jsx("code",{children:"bash-completion"})," está instalado."]}),o.jsxs("p",{children:["O ",o.jsx("strong",{children:"Bash"})," (Bourne Again SHell) é o shell padrão do Ubuntu — é o programa que interpreta seus comandos no terminal. Dominar o Bash vai além de saber comandos: é entender atalhos, histórico, expansões e recursos que multiplicam sua produtividade no terminal."]}),o.jsx("h2",{children:"1. Atalhos de Teclado"}),o.jsx(a,{title:"Atalhos essenciais do Bash",code:`# === MOVIMENTO DO CURSOR ===
  ...
  reset    # Restaurar terminal`}),o.jsxs(r,{type:"info",title:"Alternativas ao Bash",children:[o.jsx("strong",{children:"Zsh"})," (com Oh My Zsh) oferece autocompletar superior, temas e plugins. ",o.jsx("strong",{children:"Fish"})," tem syntax highlighting e sugestões automáticas. Ambos são compatíveis com a maioria dos scripts Bash."]})]})}export{n as default};
