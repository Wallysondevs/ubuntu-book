import{j as o}from"./index-C78JTu4v.js";import{P as a}from"./PageContainer-CzdnagBv.js";import{C as e}from"./CodeBlock-BrEXPPdV.js";import{I as t}from"./InfoBox-Zb5D9tAu.js";import"./house-DD5Vs8SA.js";import"./proxy-DfMCh643.js";function d(){return o.jsxs(a,{title:"Expansões do Bash",subtitle:"Guia completo de expansões do shell Bash: variáveis, chaves, til, aritmética, command substitution, globbing e manipulação de strings.",difficulty:"intermediario",timeToRead:"25 min",children:[o.jsxs("p",{children:["As ",o.jsx("strong",{children:"expansões do Bash"})," são mecanismos que transformam o texto que você digita antes de o comando ser executado. Dominar as expansões permite escrever comandos mais curtos, poderosos e elegantes — desde renomear dezenas de arquivos em uma linha até fazer cálculos e manipular strings diretamente no terminal."]}),o.jsx("h2",{children:"1. Expansão de Chaves (Brace Expansion)"}),o.jsx(e,{title:"Gerar sequências e combinações com {}",code:`# Expansão de listas
  echo {a,b,c}
  # Saída: a b c
  ...
  echo {1..5}
  set +x                # Desativa modo debug`}),o.jsx(t,{type:"info",title:"Ordem das expansões no Bash",children:"O Bash processa as expansões nesta ordem: 1) Brace expansion, 2) Tilde expansion, 3) Parameter/variable expansion, 4) Command substitution, 5) Arithmetic expansion, 6) Word splitting, 7) Pathname expansion (globbing). Entender essa ordem ajuda a prever o comportamento de comandos complexos."})]})}export{d as default};
