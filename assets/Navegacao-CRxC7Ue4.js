...
# joao@ubuntu:~$ cd /etc
# joao@ubuntu:/etc$    ← você está em /etc`}),o.jsx("p",{children:"Veja como fica no terminal, inclusive um erro típico:"}),o.jsx(r,{user:"joao",title:"joao@ubuntu: ~",lines:[{type:"cmd",text:"pwd"},{type:"out",text:"/home/joao"},{type:"cmd",text:"cd /etc/nginx  &&  pwd"},{type:"out",text:"/etc/nginx"},{type:"comment",text:"# e quando o caminho nao existe:"},{type:"cmd",text:"cd /etc/ngnix"},{type:"err",text:"bash: cd: /etc/ngnix: Arquivo ou diretorio inexistente"},{type:"warn",text:"-> erro de digitacao (ngnix != nginx). Use Tab para autocompletar."}]}),o.jsx("h2",{children:"ls — Listar Conteúdo do Diretório"}),o.jsx(e,{title:"Todas as flags do ls explicadas",code:`# Listar o diretório atual (apenas nomes)
ls
