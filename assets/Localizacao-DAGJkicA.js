import{j as e}from"./index-_kFPLDpE.js";import{P as r}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function c(){return e.jsxs(r,{title:"Localização, Idioma e Fuso Horário",subtitle:"Configurar idioma do sistema, layout de teclado, fuso horário, formatos de data/moeda e locale no Ubuntu para português brasileiro.",difficulty:"iniciante",timeToRead:"25 min",children:[e.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu com ",e.jsx("code",{children:"sudo"}),". Pode pedir reboot ou re-login após mudar locale."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"Locale"})," — conjunto de regras de idioma, formato de data, moeda e codificação (",e.jsx("code",{children:"pt_BR.UTF-8"}),")."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"LANG / LC_*"})," — LANG é o fallback geral; LC_TIME, LC_NUMERIC etc. sobrescrevem por categoria."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"locale-gen"})," — gera os arquivos binários a partir das definições escolhidas em ",e.jsx("code",{children:"/etc/locale.gen"}),"."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Timezone"})," — fuso horário. Configure com ",e.jsx("code",{children:"timedatectl set-timezone America/Sao_Paulo"}),"."]}),e.jsxs("p",{children:["A ",e.jsx("strong",{children:"localização"})," (locale) define como o sistema exibe datas, números, moeda, idioma de menus e mensagens de erro. No Ubuntu, isso é controlado por variáveis de ambiente que seguem o padrão POSIX. Configurar corretamente a localização garante que o sistema funcione em português brasileiro, com formato de data dd/mm/aaaa, moeda R$ e teclado ABNT2."]}),e.jsx("h2",{children:"1. Verificar e Configurar o Locale"}),e.jsx(o,{title:"Gerenciar locale do sistema",code:`# Ver todas as configurações de locale atuais
  locale
  # Saída:
  # LANG=pt_BR.UTF-8
  ...
  sudo apt install -y hunspell-pt-br    # Corretor ortográfico`}),e.jsxs(a,{type:"info",title:"UTF-8 é essencial",children:["Sempre use locales com ",e.jsx("code",{children:".UTF-8"})," (ex: ",e.jsx("code",{children:"pt_BR.UTF-8"}),"). UTF-8 suporta todos os caracteres do português (ç, ã, é, ü, etc.) e emojis. Locales sem UTF-8 podem causar problemas com acentos e caracteres especiais."]}),e.jsx("h2",{children:"2. Configurar o Fuso Horário"}),e.jsx(o,{title:"Gerenciar fuso horário com timedatectl",code:`# Ver a configuração atual de data/hora
  timedatectl
  # Saída:
  ...
  chronyc sources     # Ver servidores NTP em uso`}),e.jsx("h2",{children:"3. Configurar o Layout do Teclado"}),e.jsx(o,{title:"Configurar teclado ABNT2 e outros layouts",code:`# Ver a configuração atual do teclado
  localectl
  # Saída:
  ...
  sudo setupcon`}),e.jsx("h2",{children:"4. Formatos de Data, Número e Moeda"}),e.jsx(o,{title:"Personalizar formatos regionais",code:`# Testar como diferentes locales formatam dados
  # Data:
...
" 1234567.89
  ...
  LC_ALL=C date                   # Data em formato padrão inglês`}),e.jsx("h2",{children:"5. Configurar Idioma de Aplicativos"}),e.jsx(o,{title:"Instalar e gerenciar idiomas no Ubuntu",code:`# Instalar suporte completo ao português brasileiro
  ...
  # Arraste para reordenar a preferência`}),e.jsx("h2",{children:"Troubleshooting"}),e.jsx(o,{title:"Problemas comuns com localização",code:`# Erro: "locale: Cannot set LC_ALL to default locale"
  ...
  sudo apt install -y language-pack-pt language-pack-gnome-pt
  sudo update-locale LANG=pt_BR.UTF-8
  # Reiniciar`}),e.jsxs(a,{type:"info",title:"Locale para servidores",children:["Em servidores, é comum usar ",e.jsx("code",{children:"en_US.UTF-8"})," como locale padrão, mesmo no Brasil. Isso facilita a pesquisa de mensagens de erro em inglês no Google/Stack Overflow. Defina o fuso horário como ",e.jsx("code",{children:"America/Sao_Paulo"}),"mas mantenha o idioma em inglês."]})]})}export{c as default};
