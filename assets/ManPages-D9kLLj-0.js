import{j as a}from"./index-_kFPLDpE.js";import{P as o}from"./PageContainer-eafNNqkI.js";import{C as e}from"./CodeBlock-ByIkwE54.js";import{A as s}from"./AlertBox-NzOB7YP7.js";function d(){return a.jsxs(o,{title:"Man Pages — Manuais do Sistema",subtitle:"Guia completo para usar man pages, info, help, tldr e aproveitar a documentação integrada do Linux para aprender qualquer comando.",difficulty:"iniciante",timeToRead:"20 min",children:[a.jsxs("p",{children:["As ",a.jsx("strong",{children:"man pages"})," (manual pages) são a documentação oficial de cada comando, função e arquivo de configuração do Linux. É a referência mais completa e confiável — está disponível offline, diretamente no terminal, e cobre absolutamente tudo que o sistema oferece."]}),a.jsx("h2",{children:"1. Usar o man"}),a.jsx(e,{title:"Acessar e navegar nas man pages",code:`# Abrir o manual de um comando
  man ls
  man grep
  man chmod
  man ssh
  ...
  # passwd (5)  - the password file`}),a.jsx("h2",{children:"2. Alternativas ao man"}),a.jsx(e,{title:"Outras formas de obter ajuda",code:`# --help (resumo rápido de opções)
  ls --help
  grep --help
  docker --help
  ...
  # Cole qualquer comando e ele explica cada parte`}),a.jsx("h2",{children:"3. Estrutura de uma Man Page"}),a.jsx(e,{title:"Entender as seções de uma man page",code:`# Uma man page típica tem estas seções:
  ...
  man rsync
  # Digite: /--delete e Enter`}),a.jsx("h2",{children:"4. Instalar Man Pages Extras"}),a.jsx(e,{title:"Mais documentação no terminal",code:`# Man pages em português (se disponíveis)
  ...
  sudo apt install -y manpages-posix`}),a.jsx("h2",{children:"5. Navegar dentro da man page (e o less por tras dela)"}),a.jsxs("p",{children:["O ",a.jsx("code",{children:"man"})," nao mostra o texto: ele entrega para o",a.jsx("code",{children:"less"}),". Todo atalho de leitura vem de la, e saber cinco deles muda completamente a experiencia."]}),a.jsx(e,{title:"Atalhos que valem decorar",code:`man ip
...
man -f printf
whatis printf`}),a.jsx("h2",{children:"6. apropos, whatis e o banco de dados do man"}),a.jsx("p",{children:"Quando voce nao sabe o nome do comando, o caminho e buscar pela descricao. Isso depende de um indice que precisa estar atualizado."}),a.jsx(e,{title:"Buscar sem saber o nome",code:`# Procurar pela descricao
apropos "partition"
...
man ./minha-pagina.1.gz`}),a.jsx("h2",{children:"7. Man pages em portugues e leitura offline"}),a.jsx(e,{title:"Traducoes e exportacao",code:`# Pacote de traducoes (cobertura parcial, mas ajuda)
...
man -H ip`}),a.jsx("h2",{children:"8. Quando o man nao e o lugar certo"}),a.jsx("p",{children:'Parte da documentacao do sistema nunca esteve no man. Saber onde mais olhar evita a conclusao errada de que "nao existe documentacao".'}),a.jsx(e,{title:"As outras quatro fontes locais",code:`# 1. help embutido do shell (para builtins, o man nao existe)
help cd
help test
type -a cd
...
systemctl help nginx.service`}),a.jsx("h2",{children:"Troubleshooting"}),a.jsx(e,{title:"Problemas comuns com man pages",code:`# "No manual entry for xxx"
  # Instalar man pages:
  ...
  # Arch Wiki: wiki.archlinux.org (excelente para qualquer distro)`}),a.jsxs(s,{type:"info",title:"Aprenda a ler man pages",children:["No início, man pages parecem intimidadoras, mas são a documentação mais completa que existe. Comece lendo a seção DESCRIPTION e EXAMPLES. Com o tempo, você vai conseguir ler a SYNOPSIS diretamente. O ",a.jsx("code",{children:"tldr"})," é um ótimo complemento para ter exemplos práticos rápidos."]})]})}export{d as default};
