import{j as e}from"./index-_kFPLDpE.js";import{P as s}from"./PageContainer-eafNNqkI.js";import{C as o}from"./CodeBlock-ByIkwE54.js";import{A as a}from"./AlertBox-NzOB7YP7.js";function l(){return e.jsxs(s,{title:"Troubleshooting Ubuntu",subtitle:"Diagnosticando e resolvendo problemas comuns — boot, rede, espaço em disco, pacotes corrompidos e muito mais.",difficulty:"intermediario",timeToRead:"25 min",children:[e.jsxs(a,{type:"info",title:"Pré-requisitos",children:["Ubuntu instalado, ",e.jsx("code",{children:"sudo"}),". Tenha um pendrive Ubuntu live para emergências de boot."]}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("p",{children:[e.jsx("strong",{children:"journalctl"})," — primeiro lugar pra olhar — ",e.jsx("code",{children:"journalctl -xe"})," mostra erros recentes com contexto."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"dmesg"})," — mensagens do kernel — útil para hardware/driver."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"systemctl status"})," — estado de um serviço + últimas linhas de log."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Modo recovery"})," — menu do GRUB → Advanced → recovery mode → root shell."]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Live USB"})," — boot externo para reparar instalação quebrada."]}),e.jsx("p",{children:"Todo sistema Linux vai apresentar problemas em algum momento. A habilidade de diagnosticar e resolver esses problemas é o que separa um usuário experiente de um iniciante. Este guia cobre os problemas mais comuns no Ubuntu e como resolvê-los."}),e.jsx("h2",{children:"Problemas com APT e Pacotes"}),e.jsx("h3",{children:"apt está travado ou corrompido"}),e.jsx(o,{title:"Corrigir APT quebrado",code:`# Problema 1: "Could not get lock /var/lib/dpkg/lock"
